...
nlodm_folders = os.listdir('/hdfs/store/user/jjbuch/ntuples_moriond17/RunIISummer16MiniAODv2-PUMoriond17_NLODM/')

for folderName in nlodm_folders:
  folder_path = '/hdfs/store/user/jjbuch/ntuples_moriond17/RunIISummer16MiniAODv2-PUMoriond17_NLODM/'+folderName+'/'
  folderName_parts = folderName.split('_')
  sample_name = 'DM_NLO_'+folderName_parts[3]+'_'+folderName_parts[4]+'_'+folderName_parts[5]
