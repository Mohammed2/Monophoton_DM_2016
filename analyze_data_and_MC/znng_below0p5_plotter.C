...
void plot_signal(string histname_string, string sample_name, Float_t xsec, int nevents_total, string outfile_name)
{
  ...
  histo_signal->Scale(int_lumi*scale_factor*frac_below0p5*xsec/nevents_total);
  histo_signal_JESUp->Scale(int_lumi*scale_factor*frac_below0p5*xsec/nevents_total);
  histo_signal_JESDown->Scale(int_lumi*scale_factor*frac_below0p5*xsec/nevents_total);
  histo_signal_PESUp->Scale(int_lumi*scale_factor*frac_below0p5*xsec/nevents_total);
  histo_signal_PESDown->Scale(int_lumi*scale_factor*frac_below0p5*xsec/nevents_total);
  ...
  if(int_signal > 0.0)
    err_signal = sqrt(int_signal*int_signal*((xsec*int_lumi*scale_factor*frac_below0p5-int_signal)/(nevents_total*int_signal))+(jeserr_signal*jeserr_signal)+(peserr_signal*peserr_signal));
  for(int i = 1; i <= nBins; i++){
    ...
    histo_signal->SetBinError(i,err_bin);
  }
...
void plot(string histname_string, Double_t leg_xoffset, Double_t leg_yoffset, TString xaxis_title, TString plotname)
{
  ...
  TString histname_PESUp = TString(histname_string+"_27"); // Photon+MET: 12, Dphi(photon,MET): 13, lepton veto: 14, Dphi(jets,MET): 15, phoPt/MET: 27
  TString histname_PESDown = TString(histname_string+"_28"); // Photon+MET: 16, Dphi(photon,MET): 17, lepton veto: 18, Dphi(jets,MET): 19, phoPt/MET: 28
  TString histname_data = TString(histname_string+"_18"); // Photon: 12, Photon+MET: 13, Dphi(photon,MET): 14, lepton veto: 15, noisy crystal: 16, Dphi(jets,MET): 17, phoPt/MET: 18
  ...
  TString histname_wenu = TString(histname_string+"_18"); // Photon: 12, Photon+MET: 13, Dphi(photon,MET): 14, lepton veto: 15, noisy crystal: 16, Dphi(jets,MET): 17, phoPt/MET: 18
  TString histname_qcd = TString(histname_string+"_18"); // Photon: 12, Photon+MET: 13, Dphi(photon,MET): 14, lepton veto: 15, noisy crystal: 16, Dphi(jets,MET): 17
  ...
  for(int i = 1; i <= nBins; i++){
    ...
    histo_spikes->SetBinError(i,0.33*int_bin_spikes); // This bin error will be scaled a couple lines down
  }
  ...
  // histo_bhalo->Scale(1.992/int_bhalo);
  histo_bhalo->Scale(24.067/int_bhalo_unscaled); 
  histo_bhalo_MIPTotEnergyUp->Scale(24.067/int_bhalo_MIPTotEnergyUp_unscaled); 
  histo_bhalo_MIPTotEnergyDown->Scale(24.067/int_bhalo_MIPTotEnergyDown_unscaled); 
  stat_bhalo *= 24.067/int_bhalo_unscaled;
  for(int i = 1; i <= nBins; i++){
  ...
  histo_ZNuNuG_straightUp->Scale(int_lumi*scale_factor*frac_below0p5*0.18213/2040365.0);
  histo_ZNuNuG_straightDown->Scale(int_lumi*scale_factor*frac_below0p5*0.18213/2040365.0);
  histo_ZNuNuG_twistedUp->Scale(int_lumi*scale_factor*frac_below0p5*0.18213/2040365.0);
  histo_ZNuNuG_twistedDown->Scale(int_lumi*scale_factor*frac_below0p5*0.18213/2040365.0);
  histo_ZNuNuG_gammaUp->Scale(int_lumi*scale_factor*frac_below0p5*0.18213/2040365.0);
  histo_ZNuNuG_gammaDown->Scale(int_lumi*scale_factor*frac_below0p5*0.18213/2040365.0);
  histo_ZNuNuG_qcdscale->Scale(int_lumi*scale_factor*frac_below0p5*0.18213/2040365.0);
  ...
  histo_ZNuNuG_straightUp_ext->Scale(int_lumi*scale_factor*frac_below0p5*0.18213/2040365.0);
  histo_ZNuNuG_straightDown_ext->Scale(int_lumi*scale_factor*frac_below0p5*0.18213/2040365.0);
  histo_ZNuNuG_twistedUp_ext->Scale(int_lumi*scale_factor*frac_below0p5*0.18213/2040365.0);
  histo_ZNuNuG_twistedDown_ext->Scale(int_lumi*scale_factor*frac_below0p5*0.18213/2040365.0);
  histo_ZNuNuG_gammaUp_ext->Scale(int_lumi*scale_factor*frac_below0p5*0.18213/2040365.0);
  histo_ZNuNuG_gammaDown_ext->Scale(int_lumi*scale_factor*frac_below0p5*0.18213/2040365.0);
  histo_ZNuNuG_qcdscale_ext->Scale(int_lumi*scale_factor*frac_below0p5*0.18213/2040365.0);
  ...
  histo_WG->Scale(int_lumi*scale_factor*frac_below0p5*0.65521/30469887.0); // 502176(standard) + 1852305(ext) + 28115406(mitExt) = 30469887
  histo_WG_JESUp->Scale(int_lumi*scale_factor*frac_below0p5*0.65521/30469887.0);
  histo_WG_JESDown->Scale(int_lumi*scale_factor*frac_below0p5*0.65521/30469887.0);
  histo_WG_PESUp->Scale(int_lumi*scale_factor*frac_below0p5*0.65521/30469887.0);
  histo_WG_PESDown->Scale(int_lumi*scale_factor*frac_below0p5*0.65521/30469887.0);
  histo_WG_straightUp->Scale(int_lumi*scale_factor*frac_below0p5*0.65521/30469887.0);
  histo_WG_straightDown->Scale(int_lumi*scale_factor*frac_below0p5*0.65521/30469887.0);
  histo_WG_twistedUp->Scale(int_lumi*scale_factor*frac_below0p5*0.65521/30469887.0);
  histo_WG_twistedDown->Scale(int_lumi*scale_factor*frac_below0p5*0.65521/30469887.0);
  histo_WG_gammaUp->Scale(int_lumi*scale_factor*frac_below0p5*0.65521/30469887.0);
  histo_WG_gammaDown->Scale(int_lumi*scale_factor*frac_below0p5*0.65521/30469887.0);
  histo_WG_qcdscale->Scale(int_lumi*scale_factor*frac_below0p5*0.65521/30469887.0);
  ...
  for(int i = 1; i <= nBins; i++){
    ...
    double err_bin = 0.0;
    if(int_bin > 0)
      err_bin = int_bin*sqrt((0.65521*int_lumi*scale_factor*frac_below0p5-int_bin)/(30469887.0*int_bin));
    histo_WG->SetBinError(i,err_bin);
  }
  Float_t err_WG = 0.0;
  if(int_WG > 0.0){
    err_WG = sqrt(int_WG*int_WG*((photon_scale_factor_unc*photon_scale_factor_unc)+(0.65521*int_lumi*scale_factor*frac_below0p5-int_WG)/(30469887.0*int_WG))+(qcdscaleerr_WG*qcdscaleerr_WG)+(jeserr_WG*jeserr_WG)+(peserr_WG*peserr_WG)+(straighterr_WG*straighterr_WG)+(twistederr_WG*twistederr_WG)+(gammaerr_WG*gammaerr_WG)+(pdferr_WG*pdferr_WG));
    if(histname == "Photon_Et_range_24"){
      cout<<"WG fractional errors:"<<int_WG<<endl;
      cout<<"stat err = "<<sqrt(((0.65521*int_lumi*scale_factor*frac_below0p5-int_WG)/(30469887.0*int_WG)))<<endl;
  ...
  if(int_GJets_40to100>0.0)
    err_GJets_40to100 = sqrt(int_GJets_40to100*int_GJets_40to100*((photon_scale_factor_unc*photon_scale_factor_unc)+(20730.0*int_lumi*scale_factor*frac_below0p5-int_GJets_40to100)/(4269126.0*int_GJets_40to100))+(jeserr_GJets_40to100*jeserr_GJets_40to100)+(peserr_GJets_40to100*peserr_GJets_40to100));
  if(int_GJets_100to200>0.0)
    err_GJets_100to200 = sqrt(int_GJets_100to200*int_GJets_100to200*((photon_scale_factor_unc*photon_scale_factor_unc)+(9226.0*int_lumi*scale_factor*frac_below0p5-int_GJets_100to200)/(5131808.0*int_GJets_100to200))+(jeserr_GJets_100to200*jeserr_GJets_100to200)+(peserr_GJets_100to200*peserr_GJets_100to200));
  if(int_GJets_200to400>0.0)
    err_GJets_200to400 = sqrt(int_GJets_200to400*int_GJets_200to400*((photon_scale_factor_unc*photon_scale_factor_unc)+(2300.0*int_lumi*scale_factor*frac_below0p5-int_GJets_200to400)/(10036339.0*int_GJets_200to400))+(jeserr_GJets_200to400*jeserr_GJets_200to400)+(peserr_GJets_200to400*peserr_GJets_200to400));
  if(int_GJets_400to600>0.0)
    err_GJets_400to600 = sqrt(int_GJets_400to600*int_GJets_400to600*((photon_scale_factor_unc*photon_scale_factor_unc)+(277.4*int_lumi*scale_factor*frac_below0p5-int_GJets_400to600)/(2435892.0*int_GJets_400to600))+(jeserr_GJets_400to600*jeserr_GJets_400to600)+(peserr_GJets_400to600*peserr_GJets_400to600));
  if(int_GJets_600toInf>0.0)
    err_GJets_600toInf = sqrt(int_GJets_600toInf*int_GJets_600toInf*((photon_scale_factor_unc*photon_scale_factor_unc)+(93.38*int_lumi*scale_factor*frac_below0p5-int_GJets_600toInf)/(2117687.0*int_GJets_600toInf))+(jeserr_GJets_600toInf*jeserr_GJets_600toInf)+(peserr_GJets_600toInf*peserr_GJets_600toInf));
  ...
  // cout<<"GJets got"<<endl;
  // if (histname == "Photon_Et_range_24"){
  //   cout<<"nevents_passing_40to100: "<<(int_GJets_40to100*4269126.0/(int_lumi*scale_factor*frac_below0p5*20730.0))<<", nevent_total_40to100: "<<4269126<<endl;
  //   cout<<"nevents_passing_100to200: "<<(int_GJets_100to200*5131808.0/(int_lumi*scale_factor*frac_below0p5*9226.0))<<", nevent_total_100to200: "<<5131808<<endl;
  //   cout<<"nevents_passing_200to400: "<<(int_GJets_200to400*10036339.0/(int_lumi*scale_factor*frac_below0p5*2300.0))<<", nevent_total_200to400: "<<10036339<<endl;
  //   cout<<"nevents_passing_400to600: "<<(int_GJets_400to600*2435892.0/(int_lumi*scale_factor*frac_below0p5*277.4))<<", nevent_total_400to600: "<<2435892<<endl;
  //   cout<<"nevents_passing_600toInf: "<<(int_GJets_600toInf*2117687.0/(int_lumi*scale_factor*frac_below0p5*93.38))<<", nevent_total_600toInf: "<<2117687<<endl;
  //   cout<<"int_GJets_40to100: "<<int_GJets_40to100<<"+-"<<err_GJets_40to100<<"(tot), "<<"+-"<<(int_GJets_40to100*sqrt((20730.0*int_lumi*scale_factor*frac_below0p5-int_GJets_40to100)/(4269126.0*int_GJets_40to100)))<<"(stat)"<<endl;
  //   cout<<"int_GJets_100to200: "<<int_GJets_100to200<<"+-"<<err_GJets_100to200<<"(tot), "<<"+-"<<(int_GJets_100to200*sqrt((9226.0*int_lumi*scale_factor*frac_below0p5-int_GJets_100to200)/(5131808.0*int_GJets_100to200)))<<"(stat)"<<endl;
  //   cout<<"int_GJets_200to400: "<<int_GJets_200to400<<"+-"<<err_GJets_200to400<<"(tot), "<<"+-"<<(int_GJets_200to400*sqrt((2300.0*int_lumi*scale_factor*frac_below0p5-int_GJets_200to400)/(10036339.0*int_GJets_200to400)))<<"(stat)"<<endl;
  //   cout<<"int_GJets_400to600: "<<int_GJets_400to600<<"+-"<<err_GJets_400to600<<"(tot), "<<"+-"<<(int_GJets_400to600*sqrt((277.4*int_lumi*scale_factor*frac_below0p5-int_GJets_400to600)/(2435892.0*int_GJets_400to600)))<<"(stat)"<<endl;
  //   cout<<"int_GJets_600toInf: "<<int_GJets_600toInf<<"+-"<<err_GJets_600toInf<<"(tot), "<<"+-"<<(int_GJets_600toInf*sqrt((93.38*int_lumi*scale_factor*frac_below0p5-int_GJets_600toInf)/(2117687.0*int_GJets_600toInf)))<<"(stat)"<<endl;
  // }
  ...
  histo_ZllG_straightUp_130_under300->Scale(int_lumi*scale_factor*frac_below0p5*0.148/489423.0);
  histo_ZllG_straightDown_130_under300->Scale(int_lumi*scale_factor*frac_below0p5*0.148/489423.0);
  histo_ZllG_twistedUp_130_under300->Scale(int_lumi*scale_factor*frac_below0p5*0.148/489423.0);
  histo_ZllG_twistedDown_130_under300->Scale(int_lumi*scale_factor*frac_below0p5*0.148/489423.0);
  histo_ZllG_gammaUp_130_under300->Scale(int_lumi*scale_factor*frac_below0p5*0.148/489423.0);
  histo_ZllG_gammaDown_130_under300->Scale(int_lumi*scale_factor*frac_below0p5*0.148/489423.0);
  histo_ZllG_qcdscale_130_under300->Scale(int_lumi*scale_factor*frac_below0p5*0.148/489423.0);
  ...
  histo_ZllG_straightUp_300->Scale(int_lumi*scale_factor*frac_below0p5*0.0092/1707773.0);
  histo_ZllG_straightDown_300->Scale(int_lumi*scale_factor*frac_below0p5*0.0092/1707773.0);
  histo_ZllG_twistedUp_300->Scale(int_lumi*scale_factor*frac_below0p5*0.0092/1707773.0);
  histo_ZllG_twistedDown_300->Scale(int_lumi*scale_factor*frac_below0p5*0.0092/1707773.0);
  histo_ZllG_gammaUp_300->Scale(int_lumi*scale_factor*frac_below0p5*0.0092/1707773.0);
  histo_ZllG_gammaDown_300->Scale(int_lumi*scale_factor*frac_below0p5*0.0092/1707773.0);
  histo_ZllG_qcdscale_300->Scale(int_lumi*scale_factor*frac_below0p5*0.0092/1707773.0);
  ...
  if(int_ZllG > 0.0)
    err_ZllG = sqrt(int_ZllG_130_under300*int_ZllG_130_under300*((photon_scale_factor_unc*photon_scale_factor_unc)+(0.148*int_lumi*scale_factor-int_ZllG_130_under300)/(489423.0*int_ZllG_130_under300))+int_ZllG_300*int_ZllG_300*((photon_scale_factor_unc*photon_scale_factor_unc)+(0.0092*int_lumi*scale_factor-int_ZllG_300)/(1707773.0*int_ZllG_300))+(qcdscaleerr_ZllG*qcdscaleerr_ZllG)+(jeserr_ZllG*jeserr_ZllG)+(peserr_ZllG*peserr_ZllG)+(straighterr_ZllG*straighterr_ZllG)+(twistederr_ZllG*twistederr_ZllG)+(gammaerr_ZllG*gammaerr_ZllG)+(pdferr_ZllG*pdferr_ZllG));
  total_background += int_ZllG;
  background_unc_sumsquares += err_ZllG*err_ZllG;
  // histo_ZllG_combined->SetFillColor(kRed-10);
  histo_ZllG_combined->SetFillColor(kRed-5);
  ...
  // histo_WWG_phoSFUp->Scale(int_lumi*scale_factor*frac_below0p5*0.2147/827604.0);
  // histo_WWG_phoSFDown->Scale(int_lumi*scale_factor*frac_below0p5*0.2147/827604.0);
  ...
  // Float_t err_WWG = 0.0;
  // if(int_WWG > 0.0)
  //   err_WWG = sqrt(int_WWG*int_WWG*((photon_scale_factor_unc*photon_scale_factor_unc)+(0.2147*int_lumi*scale_factor*frac_below0p5-int_WWG)/(827604.0*int_WWG))+(jeserr_WWG*jeserr_WWG)+(peserr_WWG*peserr_WWG)+(phosferr_WWG*phosferr_WWG));
  ...
  // histo_WZG_phoSFUp->Scale(int_lumi*scale_factor*frac_below0p5*0.04123/844824.0);
  // histo_WZG_phoSFDown->Scale(int_lumi*scale_factor*frac_below0p5*0.04123/844824.0);
  ...
  // Float_t err_WZG = 0.0;
  // if(int_WZG > 0.0)
  //   err_WZG = sqrt(int_WZG*int_WZG*((0.04123*int_lumi*scale_factor*frac_below0p5-int_WZG)/(844824.0*int_WZG))+(jeserr_WZG*jeserr_WZG)+(peserr_WZG*peserr_WZG)+(phosferr_WZG*phosferr_WZG));
  ...
  // histo_WGG_phoSFUp->Scale(int_lumi*scale_factor*frac_below0p5*1.711/428254.0);
  // histo_WGG_phoSFDown->Scale(int_lumi*scale_factor*frac_below0p5*1.711/428254.0);
  ...
  // Float_t err_WGG = 0.0;
  // if(int_WGG > 0.0)
  //   err_WGG = sqrt(int_WGG*int_WGG*((1.711*int_lumi*scale_factor*frac_below0p5-int_WGG)/(428254.0*int_WGG))+(jeserr_WGG*jeserr_WGG)+(peserr_WGG*peserr_WGG)+(phosferr_WGG*phosferr_WGG));
  ...
  // histo_ZGGToNuNuGG_phoSFUp->Scale(int_lumi*scale_factor*frac_below0p5*0.07477/764438.0);
  // histo_ZGGToNuNuGG_phoSFDown->Scale(int_lumi*scale_factor*frac_below0p5*0.07477/764438.0);
  ...
  //   err_ZGGToNuNuGG = sqrt(int_ZGGToNuNuGG*int_ZGGToNuNuGG*((0.07477*int_lumi*scale_factor*frac_below0p5-int_ZGGToNuNuGG)/(764438.0*int_ZGGToNuNuGG))+(jeserr_ZGGToNuNuGG*jeserr_ZGGToNuNuGG)+(peserr_ZGGToNuNuGG*peserr_ZGGToNuNuGG)+(phosferr_ZGGToNuNuGG*phosferr_ZGGToNuNuGG));
  ...
  // TFile *f_signalVMx1Mv1000 = new TFile("ZnnG_JESPES_DM_V_Mx-1_Mv-1000.root");
  // TH1F* histo_signalVMx1Mv1000 = (TH1F*)((TH1F*)f_signalVMx1Mv1000->Get(histname))->Clone("histo_signalVMx1Mv1000");
  // TH1F* histo_signalVMx1Mv1000_JESUp = (TH1F*)((TH1F*)f_signalVMx1Mv1000->Get(histname_JESUp))->Clone("histo_signalVMx1Mv1000_JESUp");
  // TH1F* histo_signalVMx1Mv1000_JESDown = (TH1F*)((TH1F*)f_signalVMx1Mv1000->Get(histname_JESDown))->Clone("histo_signalVMx1Mv1000_JESDown");
  // TH1F* histo_signalVMx1Mv1000_PESUp = (TH1F*)((TH1F*)f_signalVMx1Mv1000->Get(histname_PESUp))->Clone("histo_signalVMx1Mv1000_PESUp");
  // TH1F* histo_signalVMx1Mv1000_PESDown = (TH1F*)((TH1F*)f_signalVMx1Mv1000->Get(histname_PESDown))->Clone("histo_signalVMx1Mv1000_PESDown");
  // histo_signalVMx1Mv1000->SetStats(0);
  // histo_signalVMx1Mv1000->Scale(int_lumi*scale_factor*frac_below0p5*0.01446/50000.0);
  // histo_signalVMx1Mv1000_JESUp->Scale(int_lumi*scale_factor*frac_below0p5*0.01446/50000.0);
  // histo_signalVMx1Mv1000_JESDown->Scale(int_lumi*scale_factor*frac_below0p5*0.01446/50000.0);
  // histo_signalVMx1Mv1000_PESUp->Scale(int_lumi*scale_factor*frac_below0p5*0.01446/50000.0);
  // histo_signalVMx1Mv1000_PESDown->Scale(int_lumi*scale_factor*frac_below0p5*0.01446/50000.0);
  // Float_t int_signalVMx1Mv1000 = histo_signalVMx1Mv1000->Integral()+histo_signalVMx1Mv1000->GetBinContent(0)+histo_signalVMx1Mv1000->GetBinContent(nBins+1);
  // Float_t int_signalVMx1Mv1000_JESUp = histo_signalVMx1Mv1000_JESUp->Integral()+histo_signalVMx1Mv1000_JESUp->GetBinContent(0)+histo_signalVMx1Mv1000_JESUp->GetBinContent(nBins+1);
  // Float_t int_signalVMx1Mv1000_JESDown = histo_signalVMx1Mv1000_JESDown->Integral()+histo_signalVMx1Mv1000_JESDown->GetBinContent(0)+histo_signalVMx1Mv1000_JESDown->GetBinContent(nBins+1);
  // Float_t int_signalVMx1Mv1000_PESUp = histo_signalVMx1Mv1000_PESUp->Integral()+histo_signalVMx1Mv1000_PESUp->GetBinContent(0)+histo_signalVMx1Mv1000_PESUp->GetBinContent(nBins+1);
  // Float_t int_signalVMx1Mv1000_PESDown = histo_signalVMx1Mv1000_PESDown->Integral()+histo_signalVMx1Mv1000_PESDown->GetBinContent(0)+histo_signalVMx1Mv1000_PESDown->GetBinContent(nBins+1);
  // double jeserr_signalVMx1Mv1000 = (fabs(int_signalVMx1Mv1000_JESUp-int_signalVMx1Mv1000)+fabs(int_signalVMx1Mv1000_JESDown-int_signalVMx1Mv1000))/2.0;
  // double peserr_signalVMx1Mv1000 = (fabs(int_signalVMx1Mv1000_PESUp-int_signalVMx1Mv1000)+fabs(int_signalVMx1Mv1000_PESDown-int_signalVMx1Mv1000))/2.0;
  // Float_t err_signalVMx1Mv1000 = 0.0;
  // if(int_signalVMx1Mv1000 > 0.0)
  //   err_signalVMx1Mv1000 = sqrt(int_signalVMx1Mv1000*int_signalVMx1Mv1000*((0.01446*int_lumi*scale_factor*frac_below0p5-int_signalVMx1Mv1000)/(50000.0*int_signalVMx1Mv1000))+(jeserr_signalVMx1Mv1000*jeserr_signalVMx1Mv1000)+(peserr_signalVMx1Mv1000*peserr_signalVMx1Mv1000));
  // for(int i = 1; i <= nBins; i++){
  //   double int_bin = histo_signalVMx1Mv1000->GetBinContent(i);
  //   double jesup = histo_signalVMx1Mv1000_JESUp->GetBinContent(i);
  //   double jesdown = histo_signalVMx1Mv1000_JESDown->GetBinContent(i);
  //   double pesup = histo_signalVMx1Mv1000_PESUp->GetBinContent(i);
  //   double pesdown = histo_signalVMx1Mv1000_PESDown->GetBinContent(i);
  //   // cout<<"DMVMx1Mv1000: bin="<<i<<",int_bin="<<int_bin<<",jesup="<<jesup<<",jesdown="<<jesdown<<",pesup="<<pesup<<",pesdown="<<pesdown<<endl;
    
  //   double err_bin = 0.0;
  //   if(int_bin > 0)
  //     err_bin = int_bin*sqrt((0.01446*int_lumi*scale_factor*frac_below0p5-int_bin)/(50000.0*int_bin));
  //   histo_signalVMx1Mv1000->SetBinError(i,err_bin);
  // }
  
  // TFile *f_signalVMx1Mv500 = new TFile("ZnnG_JESPES_DM_V_Mx-1_Mv-500.root");
  // TH1F* histo_signalVMx1Mv500 = (TH1F*)((TH1F*)f_signalVMx1Mv500->Get(histname))->Clone("histo_signalVMx1Mv500");
  // TH1F* histo_signalVMx1Mv500_JESUp = (TH1F*)((TH1F*)f_signalVMx1Mv500->Get(histname_JESUp))->Clone("histo_signalVMx1Mv500_JESUp");
  // TH1F* histo_signalVMx1Mv500_JESDown = (TH1F*)((TH1F*)f_signalVMx1Mv500->Get(histname_JESDown))->Clone("histo_signalVMx1Mv500_JESDown");
  // TH1F* histo_signalVMx1Mv500_PESUp = (TH1F*)((TH1F*)f_signalVMx1Mv500->Get(histname_PESUp))->Clone("histo_signalVMx1Mv500_PESUp");
  // TH1F* histo_signalVMx1Mv500_PESDown = (TH1F*)((TH1F*)f_signalVMx1Mv500->Get(histname_PESDown))->Clone("histo_signalVMx1Mv500_PESDown");
  // histo_signalVMx1Mv500->SetStats(0);
  // histo_signalVMx1Mv500->Scale(int_lumi*scale_factor*frac_below0p5*0.07464/50000.0);
  // histo_signalVMx1Mv500_JESUp->Scale(int_lumi*scale_factor*frac_below0p5*0.07464/50000.0);
  // histo_signalVMx1Mv500_JESDown->Scale(int_lumi*scale_factor*frac_below0p5*0.07464/50000.0);
  // histo_signalVMx1Mv500_PESUp->Scale(int_lumi*scale_factor*frac_below0p5*0.07464/50000.0);
  // histo_signalVMx1Mv500_PESDown->Scale(int_lumi*scale_factor*frac_below0p5*0.07464/50000.0);
  // Float_t int_signalVMx1Mv500 = histo_signalVMx1Mv500->Integral()+histo_signalVMx1Mv500->GetBinContent(0)+histo_signalVMx1Mv500->GetBinContent(nBins+1);
  // Float_t int_signalVMx1Mv500_JESUp = histo_signalVMx1Mv500_JESUp->Integral()+histo_signalVMx1Mv500_JESUp->GetBinContent(0)+histo_signalVMx1Mv500_JESUp->GetBinContent(nBins+1);
  // Float_t int_signalVMx1Mv500_JESDown = histo_signalVMx1Mv500_JESDown->Integral()+histo_signalVMx1Mv500_JESDown->GetBinContent(0)+histo_signalVMx1Mv500_JESDown->GetBinContent(nBins+1);
  // Float_t int_signalVMx1Mv500_PESUp = histo_signalVMx1Mv500_PESUp->Integral()+histo_signalVMx1Mv500_PESUp->GetBinContent(0)+histo_signalVMx1Mv500_PESUp->GetBinContent(nBins+1);
  // Float_t int_signalVMx1Mv500_PESDown = histo_signalVMx1Mv500_PESDown->Integral()+histo_signalVMx1Mv500_PESDown->GetBinContent(0)+histo_signalVMx1Mv500_PESDown->GetBinContent(nBins+1);
  // double jeserr_signalVMx1Mv500 = (fabs(int_signalVMx1Mv500_JESUp-int_signalVMx1Mv500)+fabs(int_signalVMx1Mv500_JESDown-int_signalVMx1Mv500))/2.0;
  // double peserr_signalVMx1Mv500 = (fabs(int_signalVMx1Mv500_PESUp-int_signalVMx1Mv500)+fabs(int_signalVMx1Mv500_PESDown-int_signalVMx1Mv500))/2.0;
  // Float_t err_signalVMx1Mv500 = 0.0;
  // if(int_signalVMx1Mv500 > 0.0)
  //   err_signalVMx1Mv500 = sqrt(int_signalVMx1Mv500*int_signalVMx1Mv500*((0.07464*int_lumi*scale_factor*frac_below0p5-int_signalVMx1Mv500)/(50000.0*int_signalVMx1Mv500))+(jeserr_signalVMx1Mv500*jeserr_signalVMx1Mv500)+(peserr_signalVMx1Mv500*peserr_signalVMx1Mv500));
  // for(int i = 1; i <= nBins; i++){
  //   double int_bin = histo_signalVMx1Mv500->GetBinContent(i);
  //   double jesup = histo_signalVMx1Mv500_JESUp->GetBinContent(i);
  //   double jesdown = histo_signalVMx1Mv500_JESDown->GetBinContent(i);
  //   double pesup = histo_signalVMx1Mv500_PESUp->GetBinContent(i);
  //   double pesdown = histo_signalVMx1Mv500_PESDown->GetBinContent(i);
  //   // cout<<"DMVMx1Mv500: bin="<<i<<",int_bin="<<int_bin<<",jesup="<<jesup<<",jesdown="<<jesdown<<",pesup="<<pesup<<",pesdown="<<pesdown<<endl;
    
  //   double err_bin = 0.0;
  //   if(int_bin > 0)
  //     err_bin = int_bin*sqrt((0.07464*int_lumi*scale_factor*frac_below0p5-int_bin)/(50000.0*int_bin));
  //   histo_signalVMx1Mv500->SetBinError(i,err_bin);
  // }
  
  // TFile *f_signalVMx1Mv2000 = new TFile("ZnnG_JESPES_DM_V_Mx-1_Mv-2000.root");
  // TH1F* histo_signalVMx1Mv2000 = (TH1F*)((TH1F*)f_signalVMx1Mv2000->Get(histname))->Clone("histo_signalVMx1Mv2000");
  // TH1F* histo_signalVMx1Mv2000_JESUp = (TH1F*)((TH1F*)f_signalVMx1Mv2000->Get(histname_JESUp))->Clone("histo_signalVMx1Mv2000_JESUp");
  // TH1F* histo_signalVMx1Mv2000_JESDown = (TH1F*)((TH1F*)f_signalVMx1Mv2000->Get(histname_JESDown))->Clone("histo_signalVMx1Mv2000_JESDown");
  // TH1F* histo_signalVMx1Mv2000_PESUp = (TH1F*)((TH1F*)f_signalVMx1Mv2000->Get(histname_PESUp))->Clone("histo_signalVMx1Mv2000_PESUp");
  // TH1F* histo_signalVMx1Mv2000_PESDown = (TH1F*)((TH1F*)f_signalVMx1Mv2000->Get(histname_PESDown))->Clone("histo_signalVMx1Mv2000_PESDown");
  // histo_signalVMx1Mv2000->SetStats(0);
  // histo_signalVMx1Mv2000->Scale(int_lumi*scale_factor*frac_below0p5*0.001207/47600.0);
  // histo_signalVMx1Mv2000_JESUp->Scale(int_lumi*scale_factor*frac_below0p5*0.001207/47600.0);
  // histo_signalVMx1Mv2000_JESDown->Scale(int_lumi*scale_factor*frac_below0p5*0.001207/47600.0);
  // histo_signalVMx1Mv2000_PESUp->Scale(int_lumi*scale_factor*frac_below0p5*0.001207/47600.0);
  // histo_signalVMx1Mv2000_PESDown->Scale(int_lumi*scale_factor*frac_below0p5*0.001207/47600.0);
  // Float_t int_signalVMx1Mv2000 = histo_signalVMx1Mv2000->Integral()+histo_signalVMx1Mv2000->GetBinContent(0)+histo_signalVMx1Mv2000->GetBinContent(nBins+1);
  // Float_t int_signalVMx1Mv2000_JESUp = histo_signalVMx1Mv2000_JESUp->Integral()+histo_signalVMx1Mv2000_JESUp->GetBinContent(0)+histo_signalVMx1Mv2000_JESUp->GetBinContent(nBins+1);
  // Float_t int_signalVMx1Mv2000_JESDown = histo_signalVMx1Mv2000_JESDown->Integral()+histo_signalVMx1Mv2000_JESDown->GetBinContent(0)+histo_signalVMx1Mv2000_JESDown->GetBinContent(nBins+1);
  // Float_t int_signalVMx1Mv2000_PESUp = histo_signalVMx1Mv2000_PESUp->Integral()+histo_signalVMx1Mv2000_PESUp->GetBinContent(0)+histo_signalVMx1Mv2000_PESUp->GetBinContent(nBins+1);
  // Float_t int_signalVMx1Mv2000_PESDown = histo_signalVMx1Mv2000_PESDown->Integral()+histo_signalVMx1Mv2000_PESDown->GetBinContent(0)+histo_signalVMx1Mv2000_PESDown->GetBinContent(nBins+1);
  // double jeserr_signalVMx1Mv2000 = (fabs(int_signalVMx1Mv2000_JESUp-int_signalVMx1Mv2000)+fabs(int_signalVMx1Mv2000_JESDown-int_signalVMx1Mv2000))/2.0;
  // double peserr_signalVMx1Mv2000 = (fabs(int_signalVMx1Mv2000_PESUp-int_signalVMx1Mv2000)+fabs(int_signalVMx1Mv2000_PESDown-int_signalVMx1Mv2000))/2.0;
  // Float_t err_signalVMx1Mv2000 = 0.0;
  // if(int_signalVMx1Mv2000 > 0.0)
  //   err_signalVMx1Mv2000 = sqrt(int_signalVMx1Mv2000*int_signalVMx1Mv2000*((0.001207*int_lumi*scale_factor*frac_below0p5-int_signalVMx1Mv2000)/(47600.0*int_signalVMx1Mv2000))+(jeserr_signalVMx1Mv2000*jeserr_signalVMx1Mv2000)+(peserr_signalVMx1Mv2000*peserr_signalVMx1Mv2000));
  // for(int i = 1; i <= nBins; i++){
  //   double int_bin = histo_signalVMx1Mv2000->GetBinContent(i);
  //   double jesup = histo_signalVMx1Mv2000_JESUp->GetBinContent(i);
  //   double jesdown = histo_signalVMx1Mv2000_JESDown->GetBinContent(i);
  //   double pesup = histo_signalVMx1Mv2000_PESUp->GetBinContent(i);
  //   double pesdown = histo_signalVMx1Mv2000_PESDown->GetBinContent(i);
  //   // cout<<"DMVMx1Mv2000: bin="<<i<<",int_bin="<<int_bin<<",jesup="<<jesup<<",jesdown="<<jesdown<<",pesup="<<pesup<<",pesdown="<<pesdown<<endl;
    
  //   double err_bin = 0.0;
  //   if(int_bin > 0)
  //     err_bin = int_bin*sqrt((0.001207*int_lumi*scale_factor*frac_below0p5-int_bin)/(47600.0*int_bin));
  //   histo_signalVMx1Mv2000->SetBinError(i,err_bin);
  // }
  ...
  if (histname == "Photon_Et_range_24" || histname == "pfMET_24" || histname == "Mt_24") {
    ...
    TFile* f_ZnnG_histos;
    if(histname == "Photon_Et_range_24") f_ZnnG_histos = new TFile("ZnnG_histos_below0p5_Pt.root","RECREATE");
    ...
    // histo_signalVMx1Mv1000->Write();
    // histo_signalVMx1Mv1000_JESUp->Write();
    // histo_signalVMx1Mv1000_JESDown->Write();
    // histo_signalVMx1Mv1000_PESUp->Write();
    // histo_signalVMx1Mv1000_PESDown->Write();
    // histo_signalVMx1Mv1000_phoSFUp->Write();
    // histo_signalVMx1Mv1000_phoSFDown->Write();
    // histo_signalVMx1Mv500->Write();
    // histo_signalVMx1Mv500_JESUp->Write();
    // histo_signalVMx1Mv500_JESDown->Write();
    // histo_signalVMx1Mv500_PESUp->Write();
    // histo_signalVMx1Mv500_PESDown->Write();
    // histo_signalVMx1Mv500_phoSFUp->Write();
    // histo_signalVMx1Mv500_phoSFDown->Write();
    // histo_signalVMx1Mv2000->Write();
    // histo_signalVMx1Mv2000_JESUp->Write();
    // histo_signalVMx1Mv2000_JESDown->Write();
    // histo_signalVMx1Mv2000_PESUp->Write();
    // histo_signalVMx1Mv2000_PESDown->Write();
    // histo_signalVMx1Mv2000_phoSFUp->Write();
    // histo_signalVMx1Mv2000_phoSFDown->Write();
    f_ZnnG_histos->Close();
  }
  ...
  if (histname == "Photon_Et_range_24" || histname == "pfMET_24" || histname == "h_min_dphijetmet_2"){
    for(int i = 1; i <= nBins; i++){
      ...
      // histo_signalVMx1Mv1000->SetBinContent(i,histo_signalVMx1Mv1000->GetBinContent(i)/binWidth);
      // histo_signalVMx1Mv1000->SetBinError(i,histo_signalVMx1Mv1000->GetBinError(i)/binWidth);
      // histo_signalVMx1Mv500->SetBinContent(i,histo_signalVMx1Mv500->GetBinContent(i)/binWidth);
      // histo_signalVMx1Mv500->SetBinError(i,histo_signalVMx1Mv500->GetBinError(i)/binWidth);
      // histo_signalVMx1Mv2000->SetBinContent(i,histo_signalVMx1Mv2000->GetBinContent(i)/binWidth);
      // histo_signalVMx1Mv2000->SetBinError(i,histo_signalVMx1Mv2000->GetBinError(i)/binWidth);
    }
  }
  ...
  // histo_signalVMx1Mv1000->Scale(histo_ZNuNuG->Integral() / histo_signalVMx1Mv1000->Integral());
  // histo_vector.push_back(histo_signalVMx1Mv1000);
  // histo_signalVMx1Mv500->Scale(histo_ZNuNuG->Integral() / histo_signalVMx1Mv500->Integral());
  // histo_vector.push_back(histo_signalVMx1Mv500);
  // histo_signalVMx1Mv2000->Scale(histo_ZNuNuG->Integral() / histo_signalVMx1Mv2000->Integral());
  // histo_vector.push_back(histo_signalVMx1Mv2000);
  ...
  // histo_signalVMx1Mv1000->SetLineColor(kMagenta);
  // histo_signalVMx1Mv1000->SetLineWidth(3);
  // histo_signalVMx1Mv1000->Draw("HIST SAME");
  // histo_signalVMx1Mv500->SetLineColor(kCyan);
  // histo_signalVMx1Mv500->SetLineWidth(3);
  // histo_signalVMx1Mv500->Draw("HIST SAME");
  // histo_signalVMx1Mv2000->SetLineColor(kRed);
  // histo_signalVMx1Mv2000->SetLineWidth(3);
  // histo_signalVMx1Mv2000->Draw("HIST SAME");
  ...
  // leg->AddEntry(histo_signalVMx1Mv1000,"DM,V,Mx1,Mv1000", "L");
  // leg->AddEntry(histo_signalVMx1Mv500,"DM,V,Mx1,Mv500", "L");
  // leg->AddEntry(histo_signalVMx1Mv2000,"DM,V,Mx1,Mv2000", "L");
  leg->SetNColumns(2);
  ...
  if(histname == "Photon_Et_range_24"){
    cout<<"ZnnG region (below0p5)"<<endl;
    cout<<"------------------------------------"<<endl;
...
//  histnames.push_back(TString("_24"));
...
//  plotnames.push_back(TString(""));
  ...
  TFile* f_signal_EWK_histo_Pt = new TFile("DM_EWK_histos_below0p5_Pt.root", "RECREATE");
  f_signal_EWK_histo_Pt->Close();
  plot_signal("Photon_Et_range", "DM_EWK_Mx-100", 1.092e-06, 49999, "DM_EWK_histos_below0p5_Pt.root");
  plot_signal("Photon_Et_range", "DM_EWK_Mx-10", 1.198e-06, 49998, "DM_EWK_histos_below0p5_Pt.root");
  plot_signal("Photon_Et_range", "DM_EWK_Mx-1", 1.200e-06, 49199, "DM_EWK_histos_below0p5_Pt.root");
  plot_signal("Photon_Et_range", "DM_EWK_Mx-200", 8.836e-07, 49996, "DM_EWK_histos_below0p5_Pt.root");
  plot_signal("Photon_Et_range", "DM_EWK_Mx-400", 5.138e-07, 49997, "DM_EWK_histos_below0p5_Pt.root");
  plot_signal("Photon_Et_range", "DM_EWK_Mx-50", 1.168e-06, 49999, "DM_EWK_histos_below0p5_Pt.root");
  plot_signal("Photon_Et_range", "DM_EWK_Mx-800", 1.435e-07, 49994, "DM_EWK_histos_below0p5_Pt.root");
  
  TFile* f_ADD_histos_Pt = new TFile("ADD_histos_below0p5_Pt.root", "RECREATE");
  f_ADD_histos_Pt->Close();
  plot_signal("Photon_Et_range", "ADDmonoPhoton_MD-1d-3", 4.087e-01, 50000, "ADD_histos_below0p5_Pt.root");
  plot_signal("Photon_Et_range", "ADDmonoPhoton_MD-1d-4", 5.897e-01, 48175, "ADD_histos_below0p5_Pt.root");
  plot_signal("Photon_Et_range", "ADDmonoPhoton_MD-1d-5", 9.662e-01, 48177, "ADD_histos_below0p5_Pt.root");
  plot_signal("Photon_Et_range", "ADDmonoPhoton_MD-1d-6", 1.864e+00, 50000, "ADD_histos_below0p5_Pt.root");
  plot_signal("Photon_Et_range", "ADDmonoPhoton_MD-1d-8", 1.137e+01, 50000, "ADD_histos_below0p5_Pt.root");
  plot_signal("Photon_Et_range", "ADDmonoPhoton_MD-2d-3", 5.133e-02, 49999, "ADD_histos_below0p5_Pt.root");
  plot_signal("Photon_Et_range", "ADDmonoPhoton_MD-2d-4", 5.887e-02, 50000, "ADD_histos_below0p5_Pt.root");
  plot_signal("Photon_Et_range", "ADDmonoPhoton_MD-2d-5", 6.999e-02, 48174, "ADD_histos_below0p5_Pt.root");
  plot_signal("Photon_Et_range", "ADDmonoPhoton_MD-2d-6", 8.776e-02, 49999, "ADD_histos_below0p5_Pt.root");
  plot_signal("Photon_Et_range", "ADDmonoPhoton_MD-2d-8", 1.686e-01, 50000, "ADD_histos_below0p5_Pt.root");
  plot_signal("Photon_Et_range", "ADDmonoPhoton_MD-3d-3", 1.076e-02, 48848, "ADD_histos_below0p5_Pt.root");
  plot_signal("Photon_Et_range", "ADDmonoPhoton_MD-3d-4", 1.053e-02, 49500, "ADD_histos_below0p5_Pt.root");
  plot_signal("Photon_Et_range", "ADDmonoPhoton_MD-3d-5", 1.055e-02, 50000, "ADD_histos_below0p5_Pt.root");
  plot_signal("Photon_Et_range", "ADDmonoPhoton_MD-3d-6", 1.093e-02, 49999, "ADD_histos_below0p5_Pt.root");
  plot_signal("Photon_Et_range", "ADDmonoPhoton_MD-3d-8", 1.240e-02, 49995, "ADD_histos_below0p5_Pt.root");
  plot_signal("Photon_Et_range", "ADDmonoPhoton_MD-4d-3", 1.066e-03, 49999, "ADD_histos_below0p5_Pt.root");
  plot_signal("Photon_Et_range", "ADDmonoPhoton_MD-4d-4", 7.487e-04, 50000, "ADD_histos_below0p5_Pt.root");
  plot_signal("Photon_Et_range", "ADDmonoPhoton_MD-4d-5", 5.648e-04, 49999, "ADD_histos_below0p5_Pt.root");
  plot_signal("Photon_Et_range", "ADDmonoPhoton_MD-4d-6", 4.371e-04, 50000, "ADD_histos_below0p5_Pt.root");
  plot_signal("Photon_Et_range", "ADDmonoPhoton_MD-4d-8", 2.798e-04, 49999, "ADD_histos_below0p5_Pt.root");
  plot_signal("Photon_Et_range", "ADDmonoPhoton_MD-5d-3", 4.337e-04, 49999, "ADD_histos_below0p5_Pt.root");
  plot_signal("Photon_Et_range", "ADDmonoPhoton_MD-5d-4", 2.623e-04, 49999, "ADD_histos_below0p5_Pt.root");
  plot_signal("Photon_Et_range", "ADDmonoPhoton_MD-5d-5", 1.694e-04, 49999, "ADD_histos_below0p5_Pt.root");
  plot_signal("Photon_Et_range", "ADDmonoPhoton_MD-5d-6", 1.155e-04, 49999, "ADD_histos_below0p5_Pt.root");
  plot_signal("Photon_Et_range", "ADDmonoPhoton_MD-5d-8", 5.795e-05, 49998, "ADD_histos_below0p5_Pt.root");
  plot_signal("Photon_Et_range", "ADDmonoPhoton_MD-6d-3", 3.047e-03, 31434, "ADD_histos_below0p5_Pt.root");
  plot_signal("Photon_Et_range", "ADDmonoPhoton_MD-6d-4", 2.537e-03, 50000, "ADD_histos_below0p5_Pt.root");
  plot_signal("Photon_Et_range", "ADDmonoPhoton_MD-6d-5", 2.199e-03, 49999, "ADD_histos_below0p5_Pt.root");
  plot_signal("Photon_Et_range", "ADDmonoPhoton_MD-6d-6", 1.959e-03, 49052, "ADD_histos_below0p5_Pt.root");
  plot_signal("Photon_Et_range", "ADDmonoPhoton_MD-6d-8", 1.623e-03, 49999, "ADD_histos_below0p5_Pt.root");
    
  TFile* f_signal_NLO_pta130_histos_Pt = new TFile("DM_NLO_pta130_histos_below0p5_Pt.root", "RECREATE");
  f_signal_NLO_pta130_histos_Pt->Close();
  plot_signal("Photon_Et_range", "DM_NLO_Axial_Mx-10_Mv-1000_pta130", 1.703e-02, 40143, "DM_NLO_pta130_histos_below0p5_Pt.root");
  plot_signal("Photon_Et_range", "DM_NLO_Axial_Mx-10_Mv-100_pta130", 9.359e-01, 32922, "DM_NLO_pta130_histos_below0p5_Pt.root");
  plot_signal("Photon_Et_range", "DM_NLO_Axial_Mx-10_Mv-1500_pta130", 4.044e-03, 22182, "DM_NLO_pta130_histos_below0p5_Pt.root");
  plot_signal("Photon_Et_range", "DM_NLO_Axial_Mx-10_Mv-2000_pta130", 1.143e-03, 42611, "DM_NLO_pta130_histos_below0p5_Pt.root");
  plot_signal("Photon_Et_range", "DM_NLO_Axial_Mx-10_Mv-500_pta130", 1.057e-01, 36568, "DM_NLO_pta130_histos_below0p5_Pt.root");
  plot_signal("Photon_Et_range", "DM_NLO_Axial_Mx-10_Mv-50_pta130", 1.474e+00, 45184, "DM_NLO_pta130_histos_below0p5_Pt.root");
  plot_signal("Photon_Et_range", "DM_NLO_Axial_Mx-150_Mv-1000_pta130", 1.530e-02, 31254, "DM_NLO_pta130_histos_below0p5_Pt.root");
  plot_signal("Photon_Et_range", "DM_NLO_Axial_Mx-150_Mv-1500_pta130", 3.884e-03, 38513, "DM_NLO_pta130_histos_below0p5_Pt.root");
  plot_signal("Photon_Et_range", "DM_NLO_Axial_Mx-150_Mv-2000_pta130", 1.106e-03, 46941, "DM_NLO_pta130_histos_below0p5_Pt.root");
  plot_signal("Photon_Et_range", "DM_NLO_Axial_Mx-150_Mv-500_pta130", 7.102e-02, 57338, "DM_NLO_pta130_histos_below0p5_Pt.root");
  plot_signal("Photon_Et_range", "DM_NLO_Axial_Mx-1_Mv-1000_pta130", 1.704e-02, 44497, "DM_NLO_pta130_histos_below0p5_Pt.root");
  plot_signal("Photon_Et_range", "DM_NLO_Axial_Mx-1_Mv-100_pta130", 9.714e-01, 46369, "DM_NLO_pta130_histos_below0p5_Pt.root");
  plot_signal("Photon_Et_range", "DM_NLO_Axial_Mx-1_Mv-1500_pta130", 4.032e-03, 45043, "DM_NLO_pta130_histos_below0p5_Pt.root");
  plot_signal("Photon_Et_range", "DM_NLO_Axial_Mx-1_Mv-50_pta130", 1.664e+00, 35464, "DM_NLO_pta130_histos_below0p5_Pt.root");
  plot_signal("Photon_Et_range", "DM_NLO_Axial_Mx-40_Mv-100_pta130", 3.718e-01, 50035, "DM_NLO_pta130_histos_below0p5_Pt.root");
  plot_signal("Photon_Et_range", "DM_NLO_Axial_Mx-490_Mv-1000_pta130", 5.865e-04, 35380, "DM_NLO_pta130_histos_below0p5_Pt.root");
  plot_signal("Photon_Et_range", "DM_NLO_Axial_Mx-500_Mv-1500_pta130", 2.200e-03, 40265, "DM_NLO_pta130_histos_below0p5_Pt.root");
  plot_signal("Photon_Et_range", "DM_NLO_Axial_Mx-500_Mv-2000_pta130", 8.270e-04, 33174, "DM_NLO_pta130_histos_below0p5_Pt.root");
  plot_signal("Photon_Et_range", "DM_NLO_Axial_Mx-50_Mv-1500_pta130", 4.038e-03, 42700, "DM_NLO_pta130_histos_below0p5_Pt.root");
  plot_signal("Photon_Et_range", "DM_NLO_Axial_Mx-50_Mv-2000_pta130", 1.132e-03, 56252, "DM_NLO_pta130_histos_below0p5_Pt.root");
  plot_signal("Photon_Et_range", "DM_NLO_Axial_Mx-50_Mv-500_pta130", 1.018e-01, 30526, "DM_NLO_pta130_histos_below0p5_Pt.root");
  plot_signal("Photon_Et_range", "DM_NLO_Vector_Mx-10_Mv-1000_pta130", 1.664e-02, 39215, "DM_NLO_pta130_histos_below0p5_Pt.root");
  plot_signal("Photon_Et_range", "DM_NLO_Vector_Mx-10_Mv-100_pta130", 9.464e-01, 49324, "DM_NLO_pta130_histos_below0p5_Pt.root");
  // plot_signal("Photon_Et_range", "DM_NLO_Vector_Mx-10_Mv-1500_pta130", XSEC_NOT_SET, 415, "DM_NLO_pta130_histos_below0p5_Pt.root");
  plot_signal("Photon_Et_range", "DM_NLO_Vector_Mx-10_Mv-2000_pta130", 1.134e-03, 41602, "DM_NLO_pta130_histos_below0p5_Pt.root");
  plot_signal("Photon_Et_range", "DM_NLO_Vector_Mx-10_Mv-500_pta130", 9.890e-02, 42281, "DM_NLO_pta130_histos_below0p5_Pt.root");
  plot_signal("Photon_Et_range", "DM_NLO_Vector_Mx-150_Mv-1000_pta130", 1.690e-02, 49272, "DM_NLO_pta130_histos_below0p5_Pt.root");
  // plot_signal("Photon_Et_range", "DM_NLO_Vector_Mx-150_Mv-2000_pta130", XSEC_NOT_SET, 32572, "DM_NLO_pta130_histos_below0p5_Pt.root");
  // plot_signal("Photon_Et_range", "DM_NLO_Vector_Mx-150_Mv-500_pta130", XSEC_NOT_SET, 110, "DM_NLO_pta130_histos_below0p5_Pt.root");
  plot_signal("Photon_Et_range", "DM_NLO_Vector_Mx-1_Mv-1000_pta130", 1.664e-02, 42278, "DM_NLO_pta130_histos_below0p5_Pt.root");
  plot_signal("Photon_Et_range", "DM_NLO_Vector_Mx-1_Mv-100_pta130", 9.783e-01, 29130, "DM_NLO_pta130_histos_below0p5_Pt.root");
  plot_signal("Photon_Et_range", "DM_NLO_Vector_Mx-1_Mv-1500_pta130", 3.968e-03, 36697, "DM_NLO_pta130_histos_below0p5_Pt.root");
  plot_signal("Photon_Et_range", "DM_NLO_Vector_Mx-1_Mv-2000_pta130", 1.132e-03, 33436, "DM_NLO_pta130_histos_below0p5_Pt.root");
  plot_signal("Photon_Et_range", "DM_NLO_Vector_Mx-1_Mv-500_pta130", 1.001e-01, 47448, "DM_NLO_pta130_histos_below0p5_Pt.root");
  plot_signal("Photon_Et_range", "DM_NLO_Vector_Mx-1_Mv-50_pta130", 1.678e+00, 41448, "DM_NLO_pta130_histos_below0p5_Pt.root");
  plot_signal("Photon_Et_range", "DM_NLO_Vector_Mx-40_Mv-100_pta130", 8.362e-01, 48583, "DM_NLO_pta130_histos_below0p5_Pt.root");
  plot_signal("Photon_Et_range", "DM_NLO_Vector_Mx-490_Mv-1000_pta130", 6.709e-03, 38429, "DM_NLO_pta130_histos_below0p5_Pt.root");
  plot_signal("Photon_Et_range", "DM_NLO_Vector_Mx-500_Mv-1500_pta130", 3.620e-03, 25643, "DM_NLO_pta130_histos_below0p5_Pt.root");
  plot_signal("Photon_Et_range", "DM_NLO_Vector_Mx-500_Mv-2000_pta130", 1.071e-03, 42904, "DM_NLO_pta130_histos_below0p5_Pt.root");
  plot_signal("Photon_Et_range", "DM_NLO_Vector_Mx-50_Mv-1000_pta130", 1.705e-02, 43718, "DM_NLO_pta130_histos_below0p5_Pt.root");
  plot_signal("Photon_Et_range", "DM_NLO_Vector_Mx-50_Mv-2000_pta130", 1.144e-03, 43491, "DM_NLO_pta130_histos_below0p5_Pt.root");
  
  TFile* f_signal_EWK_histo_MET = new TFile("DM_EWK_histos_below0p5_MET.root", "RECREATE");
  f_signal_EWK_histo_MET->Close();
  plot_signal("pfMET", "DM_EWK_Mx-100", 1.092e-06, 49999, "DM_EWK_histos_below0p5_MET.root");
  plot_signal("pfMET", "DM_EWK_Mx-10", 1.198e-06, 49998, "DM_EWK_histos_below0p5_MET.root");
  plot_signal("pfMET", "DM_EWK_Mx-1", 1.200e-06, 49199, "DM_EWK_histos_below0p5_MET.root");
  plot_signal("pfMET", "DM_EWK_Mx-200", 8.836e-07, 49996, "DM_EWK_histos_below0p5_MET.root");
  plot_signal("pfMET", "DM_EWK_Mx-400", 5.138e-07, 49997, "DM_EWK_histos_below0p5_MET.root");
  plot_signal("pfMET", "DM_EWK_Mx-50", 1.168e-06, 49999, "DM_EWK_histos_below0p5_MET.root");
  plot_signal("pfMET", "DM_EWK_Mx-800", 1.435e-07, 49994, "DM_EWK_histos_below0p5_MET.root");
  
  TFile* f_ADD_histos_MET = new TFile("ADD_histos_below0p5_MET.root", "RECREATE");
  f_ADD_histos_MET->Close();
  plot_signal("pfMET", "ADDmonoPhoton_MD-1d-3", 4.087e-01, 50000, "ADD_histos_below0p5_MET.root");
  plot_signal("pfMET", "ADDmonoPhoton_MD-1d-4", 5.897e-01, 48175, "ADD_histos_below0p5_MET.root");
  plot_signal("pfMET", "ADDmonoPhoton_MD-1d-5", 9.662e-01, 48177, "ADD_histos_below0p5_MET.root");
  plot_signal("pfMET", "ADDmonoPhoton_MD-1d-6", 1.864e+00, 50000, "ADD_histos_below0p5_MET.root");
  plot_signal("pfMET", "ADDmonoPhoton_MD-1d-8", 1.137e+01, 50000, "ADD_histos_below0p5_MET.root");
  plot_signal("pfMET", "ADDmonoPhoton_MD-2d-3", 5.133e-02, 49999, "ADD_histos_below0p5_MET.root");
  plot_signal("pfMET", "ADDmonoPhoton_MD-2d-4", 5.887e-02, 50000, "ADD_histos_below0p5_MET.root");
  plot_signal("pfMET", "ADDmonoPhoton_MD-2d-5", 6.999e-02, 48174, "ADD_histos_below0p5_MET.root");
  plot_signal("pfMET", "ADDmonoPhoton_MD-2d-6", 8.776e-02, 49999, "ADD_histos_below0p5_MET.root");
  plot_signal("pfMET", "ADDmonoPhoton_MD-2d-8", 1.686e-01, 50000, "ADD_histos_below0p5_MET.root");
  plot_signal("pfMET", "ADDmonoPhoton_MD-3d-3", 1.076e-02, 48848, "ADD_histos_below0p5_MET.root");
  plot_signal("pfMET", "ADDmonoPhoton_MD-3d-4", 1.053e-02, 49500, "ADD_histos_below0p5_MET.root");
  plot_signal("pfMET", "ADDmonoPhoton_MD-3d-5", 1.055e-02, 50000, "ADD_histos_below0p5_MET.root");
  plot_signal("pfMET", "ADDmonoPhoton_MD-3d-6", 1.093e-02, 49999, "ADD_histos_below0p5_MET.root");
  plot_signal("pfMET", "ADDmonoPhoton_MD-3d-8", 1.240e-02, 49995, "ADD_histos_below0p5_MET.root");
  plot_signal("pfMET", "ADDmonoPhoton_MD-4d-3", 1.066e-03, 49999, "ADD_histos_below0p5_MET.root");
  plot_signal("pfMET", "ADDmonoPhoton_MD-4d-4", 7.487e-04, 50000, "ADD_histos_below0p5_MET.root");
  plot_signal("pfMET", "ADDmonoPhoton_MD-4d-5", 5.648e-04, 49999, "ADD_histos_below0p5_MET.root");
  plot_signal("pfMET", "ADDmonoPhoton_MD-4d-6", 4.371e-04, 50000, "ADD_histos_below0p5_MET.root");
  plot_signal("pfMET", "ADDmonoPhoton_MD-4d-8", 2.798e-04, 49999, "ADD_histos_below0p5_MET.root");
  plot_signal("pfMET", "ADDmonoPhoton_MD-5d-3", 4.337e-04, 49999, "ADD_histos_below0p5_MET.root");
  plot_signal("pfMET", "ADDmonoPhoton_MD-5d-4", 2.623e-04, 49999, "ADD_histos_below0p5_MET.root");
  plot_signal("pfMET", "ADDmonoPhoton_MD-5d-5", 1.694e-04, 49999, "ADD_histos_below0p5_MET.root");
  plot_signal("pfMET", "ADDmonoPhoton_MD-5d-6", 1.155e-04, 49999, "ADD_histos_below0p5_MET.root");
  plot_signal("pfMET", "ADDmonoPhoton_MD-5d-8", 5.795e-05, 49998, "ADD_histos_below0p5_MET.root");
  plot_signal("pfMET", "ADDmonoPhoton_MD-6d-3", 3.047e-03, 31434, "ADD_histos_below0p5_MET.root");
  plot_signal("pfMET", "ADDmonoPhoton_MD-6d-4", 2.537e-03, 50000, "ADD_histos_below0p5_MET.root");
  plot_signal("pfMET", "ADDmonoPhoton_MD-6d-5", 2.199e-03, 49999, "ADD_histos_below0p5_MET.root");
  plot_signal("pfMET", "ADDmonoPhoton_MD-6d-6", 1.959e-03, 49052, "ADD_histos_below0p5_MET.root");
  plot_signal("pfMET", "ADDmonoPhoton_MD-6d-8", 1.623e-03, 49999, "ADD_histos_below0p5_MET.root");
    
  TFile* f_signal_NLO_pta130_histos_MET = new TFile("DM_NLO_pta130_histos_below0p5_MET.root", "RECREATE");
  f_signal_NLO_pta130_histos_MET->Close();
  plot_signal("pfMET", "DM_NLO_Axial_Mx-10_Mv-1000_pta130", 1.703e-02, 40143, "DM_NLO_pta130_histos_below0p5_MET.root");
  plot_signal("pfMET", "DM_NLO_Axial_Mx-10_Mv-100_pta130", 9.359e-01, 32922, "DM_NLO_pta130_histos_below0p5_MET.root");
  plot_signal("pfMET", "DM_NLO_Axial_Mx-10_Mv-1500_pta130", 4.044e-03, 22182, "DM_NLO_pta130_histos_below0p5_MET.root");
  plot_signal("pfMET", "DM_NLO_Axial_Mx-10_Mv-2000_pta130", 1.143e-03, 42611, "DM_NLO_pta130_histos_below0p5_MET.root");
  plot_signal("pfMET", "DM_NLO_Axial_Mx-10_Mv-500_pta130", 1.057e-01, 36568, "DM_NLO_pta130_histos_below0p5_MET.root");
  plot_signal("pfMET", "DM_NLO_Axial_Mx-10_Mv-50_pta130", 1.474e+00, 45184, "DM_NLO_pta130_histos_below0p5_MET.root");
  plot_signal("pfMET", "DM_NLO_Axial_Mx-150_Mv-1000_pta130", 1.530e-02, 31254, "DM_NLO_pta130_histos_below0p5_MET.root");
  plot_signal("pfMET", "DM_NLO_Axial_Mx-150_Mv-1500_pta130", 3.884e-03, 38513, "DM_NLO_pta130_histos_below0p5_MET.root");
  plot_signal("pfMET", "DM_NLO_Axial_Mx-150_Mv-2000_pta130", 1.106e-03, 46941, "DM_NLO_pta130_histos_below0p5_MET.root");
  plot_signal("pfMET", "DM_NLO_Axial_Mx-150_Mv-500_pta130", 7.102e-02, 57338, "DM_NLO_pta130_histos_below0p5_MET.root");
  plot_signal("pfMET", "DM_NLO_Axial_Mx-1_Mv-1000_pta130", 1.704e-02, 44497, "DM_NLO_pta130_histos_below0p5_MET.root");
  plot_signal("pfMET", "DM_NLO_Axial_Mx-1_Mv-100_pta130", 9.714e-01, 46369, "DM_NLO_pta130_histos_below0p5_MET.root");
  plot_signal("pfMET", "DM_NLO_Axial_Mx-1_Mv-1500_pta130", 4.032e-03, 45043, "DM_NLO_pta130_histos_below0p5_MET.root");
  plot_signal("pfMET", "DM_NLO_Axial_Mx-1_Mv-50_pta130", 1.664e+00, 35464, "DM_NLO_pta130_histos_below0p5_MET.root");
  plot_signal("pfMET", "DM_NLO_Axial_Mx-40_Mv-100_pta130", 3.718e-01, 50035, "DM_NLO_pta130_histos_below0p5_MET.root");
  plot_signal("pfMET", "DM_NLO_Axial_Mx-490_Mv-1000_pta130", 5.865e-04, 35380, "DM_NLO_pta130_histos_below0p5_MET.root");
  plot_signal("pfMET", "DM_NLO_Axial_Mx-500_Mv-1500_pta130", 2.200e-03, 40265, "DM_NLO_pta130_histos_below0p5_MET.root");
  plot_signal("pfMET", "DM_NLO_Axial_Mx-500_Mv-2000_pta130", 8.270e-04, 33174, "DM_NLO_pta130_histos_below0p5_MET.root");
  plot_signal("pfMET", "DM_NLO_Axial_Mx-50_Mv-1500_pta130", 4.038e-03, 42700, "DM_NLO_pta130_histos_below0p5_MET.root");
  plot_signal("pfMET", "DM_NLO_Axial_Mx-50_Mv-2000_pta130", 1.132e-03, 56252, "DM_NLO_pta130_histos_below0p5_MET.root");
  plot_signal("pfMET", "DM_NLO_Axial_Mx-50_Mv-500_pta130", 1.018e-01, 30526, "DM_NLO_pta130_histos_below0p5_MET.root");
  plot_signal("pfMET", "DM_NLO_Vector_Mx-10_Mv-1000_pta130", 1.664e-02, 39215, "DM_NLO_pta130_histos_below0p5_MET.root");
  plot_signal("pfMET", "DM_NLO_Vector_Mx-10_Mv-100_pta130", 9.464e-01, 49324, "DM_NLO_pta130_histos_below0p5_MET.root");
  // plot_signal("pfMET", "DM_NLO_Vector_Mx-10_Mv-1500_pta130", XSEC_NOT_SET, 415, "DM_NLO_pta130_histos_below0p5_MET.root");
  plot_signal("pfMET", "DM_NLO_Vector_Mx-10_Mv-2000_pta130", 1.134e-03, 41602, "DM_NLO_pta130_histos_below0p5_MET.root");
  plot_signal("pfMET", "DM_NLO_Vector_Mx-10_Mv-500_pta130", 9.890e-02, 42281, "DM_NLO_pta130_histos_below0p5_MET.root");
  plot_signal("pfMET", "DM_NLO_Vector_Mx-150_Mv-1000_pta130", 1.690e-02, 49272, "DM_NLO_pta130_histos_below0p5_MET.root");
  // plot_signal("pfMET", "DM_NLO_Vector_Mx-150_Mv-2000_pta130", XSEC_NOT_SET, 32572, "DM_NLO_pta130_histos_below0p5_MET.root");
  // plot_signal("pfMET", "DM_NLO_Vector_Mx-150_Mv-500_pta130", XSEC_NOT_SET, 110, "DM_NLO_pta130_histos_below0p5_MET.root");
  plot_signal("pfMET", "DM_NLO_Vector_Mx-1_Mv-1000_pta130", 1.664e-02, 42278, "DM_NLO_pta130_histos_below0p5_MET.root");
  plot_signal("pfMET", "DM_NLO_Vector_Mx-1_Mv-100_pta130", 9.783e-01, 29130, "DM_NLO_pta130_histos_below0p5_MET.root");
  plot_signal("pfMET", "DM_NLO_Vector_Mx-1_Mv-1500_pta130", 3.968e-03, 36697, "DM_NLO_pta130_histos_below0p5_MET.root");
  plot_signal("pfMET", "DM_NLO_Vector_Mx-1_Mv-2000_pta130", 1.132e-03, 33436, "DM_NLO_pta130_histos_below0p5_MET.root");
  plot_signal("pfMET", "DM_NLO_Vector_Mx-1_Mv-500_pta130", 1.001e-01, 47448, "DM_NLO_pta130_histos_below0p5_MET.root");
  plot_signal("pfMET", "DM_NLO_Vector_Mx-1_Mv-50_pta130", 1.678e+00, 41448, "DM_NLO_pta130_histos_below0p5_MET.root");
  plot_signal("pfMET", "DM_NLO_Vector_Mx-40_Mv-100_pta130", 8.362e-01, 48583, "DM_NLO_pta130_histos_below0p5_MET.root");
  plot_signal("pfMET", "DM_NLO_Vector_Mx-490_Mv-1000_pta130", 6.709e-03, 38429, "DM_NLO_pta130_histos_below0p5_MET.root");
  plot_signal("pfMET", "DM_NLO_Vector_Mx-500_Mv-1500_pta130", 3.620e-03, 25643, "DM_NLO_pta130_histos_below0p5_MET.root");
  plot_signal("pfMET", "DM_NLO_Vector_Mx-500_Mv-2000_pta130", 1.071e-03, 42904, "DM_NLO_pta130_histos_below0p5_MET.root");
  plot_signal("pfMET", "DM_NLO_Vector_Mx-50_Mv-1000_pta130", 1.705e-02, 43718, "DM_NLO_pta130_histos_below0p5_MET.root");
  plot_signal("pfMET", "DM_NLO_Vector_Mx-50_Mv-2000_pta130", 1.144e-03, 43491, "DM_NLO_pta130_histos_below0p5_MET.root");
  
  TFile* f_signal_EWK_histo_Mt = new TFile("DM_EWK_histos_below0p5_Mt.root", "RECREATE");
  f_signal_EWK_histo_Mt->Close();
  plot_signal("Mt", "DM_EWK_Mx-100", 1.092e-06, 49999, "DM_EWK_histos_below0p5_Mt.root");
  plot_signal("Mt", "DM_EWK_Mx-10", 1.198e-06, 49998, "DM_EWK_histos_below0p5_Mt.root");
  plot_signal("Mt", "DM_EWK_Mx-1", 1.200e-06, 49199, "DM_EWK_histos_below0p5_Mt.root");
  plot_signal("Mt", "DM_EWK_Mx-200", 8.836e-07, 49996, "DM_EWK_histos_below0p5_Mt.root");
  plot_signal("Mt", "DM_EWK_Mx-400", 5.138e-07, 49997, "DM_EWK_histos_below0p5_Mt.root");
  plot_signal("Mt", "DM_EWK_Mx-50", 1.168e-06, 49999, "DM_EWK_histos_below0p5_Mt.root");
  plot_signal("Mt", "DM_EWK_Mx-800", 1.435e-07, 49994, "DM_EWK_histos_below0p5_Mt.root");
  
  TFile* f_ADD_histos_Mt = new TFile("ADD_histos_below0p5_Mt.root", "RECREATE");
  f_ADD_histos_Mt->Close();
  plot_signal("Mt", "ADDmonoPhoton_MD-1d-3", 4.087e-01, 50000, "ADD_histos_below0p5_Mt.root");
  plot_signal("Mt", "ADDmonoPhoton_MD-1d-4", 5.897e-01, 48175, "ADD_histos_below0p5_Mt.root");
  plot_signal("Mt", "ADDmonoPhoton_MD-1d-5", 9.662e-01, 48177, "ADD_histos_below0p5_Mt.root");
  plot_signal("Mt", "ADDmonoPhoton_MD-1d-6", 1.864e+00, 50000, "ADD_histos_below0p5_Mt.root");
  plot_signal("Mt", "ADDmonoPhoton_MD-1d-8", 1.137e+01, 50000, "ADD_histos_below0p5_Mt.root");
  plot_signal("Mt", "ADDmonoPhoton_MD-2d-3", 5.133e-02, 49999, "ADD_histos_below0p5_Mt.root");
  plot_signal("Mt", "ADDmonoPhoton_MD-2d-4", 5.887e-02, 50000, "ADD_histos_below0p5_Mt.root");
  plot_signal("Mt", "ADDmonoPhoton_MD-2d-5", 6.999e-02, 48174, "ADD_histos_below0p5_Mt.root");
  plot_signal("Mt", "ADDmonoPhoton_MD-2d-6", 8.776e-02, 49999, "ADD_histos_below0p5_Mt.root");
  plot_signal("Mt", "ADDmonoPhoton_MD-2d-8", 1.686e-01, 50000, "ADD_histos_below0p5_Mt.root");
  plot_signal("Mt", "ADDmonoPhoton_MD-3d-3", 1.076e-02, 48848, "ADD_histos_below0p5_Mt.root");
  plot_signal("Mt", "ADDmonoPhoton_MD-3d-4", 1.053e-02, 49500, "ADD_histos_below0p5_Mt.root");
  plot_signal("Mt", "ADDmonoPhoton_MD-3d-5", 1.055e-02, 50000, "ADD_histos_below0p5_Mt.root");
  plot_signal("Mt", "ADDmonoPhoton_MD-3d-6", 1.093e-02, 49999, "ADD_histos_below0p5_Mt.root");
  plot_signal("Mt", "ADDmonoPhoton_MD-3d-8", 1.240e-02, 49995, "ADD_histos_below0p5_Mt.root");
  plot_signal("Mt", "ADDmonoPhoton_MD-4d-3", 1.066e-03, 49999, "ADD_histos_below0p5_Mt.root");
  plot_signal("Mt", "ADDmonoPhoton_MD-4d-4", 7.487e-04, 50000, "ADD_histos_below0p5_Mt.root");
  plot_signal("Mt", "ADDmonoPhoton_MD-4d-5", 5.648e-04, 49999, "ADD_histos_below0p5_Mt.root");
  plot_signal("Mt", "ADDmonoPhoton_MD-4d-6", 4.371e-04, 50000, "ADD_histos_below0p5_Mt.root");
  plot_signal("Mt", "ADDmonoPhoton_MD-4d-8", 2.798e-04, 49999, "ADD_histos_below0p5_Mt.root");
  plot_signal("Mt", "ADDmonoPhoton_MD-5d-3", 4.337e-04, 49999, "ADD_histos_below0p5_Mt.root");
  plot_signal("Mt", "ADDmonoPhoton_MD-5d-4", 2.623e-04, 49999, "ADD_histos_below0p5_Mt.root");
  plot_signal("Mt", "ADDmonoPhoton_MD-5d-5", 1.694e-04, 49999, "ADD_histos_below0p5_Mt.root");
  plot_signal("Mt", "ADDmonoPhoton_MD-5d-6", 1.155e-04, 49999, "ADD_histos_below0p5_Mt.root");
  plot_signal("Mt", "ADDmonoPhoton_MD-5d-8", 5.795e-05, 49998, "ADD_histos_below0p5_Mt.root");
  plot_signal("Mt", "ADDmonoPhoton_MD-6d-3", 3.047e-03, 31434, "ADD_histos_below0p5_Mt.root");
  plot_signal("Mt", "ADDmonoPhoton_MD-6d-4", 2.537e-03, 50000, "ADD_histos_below0p5_Mt.root");
  plot_signal("Mt", "ADDmonoPhoton_MD-6d-5", 2.199e-03, 49999, "ADD_histos_below0p5_Mt.root");
  plot_signal("Mt", "ADDmonoPhoton_MD-6d-6", 1.959e-03, 49052, "ADD_histos_below0p5_Mt.root");
  plot_signal("Mt", "ADDmonoPhoton_MD-6d-8", 1.623e-03, 49999, "ADD_histos_below0p5_Mt.root");
    
  TFile* f_signal_NLO_pta130_histos_Mt = new TFile("DM_NLO_pta130_histos_below0p5_Mt.root", "RECREATE");
  f_signal_NLO_pta130_histos_Mt->Close();
  plot_signal("Mt", "DM_NLO_Axial_Mx-10_Mv-1000_pta130", 1.703e-02, 40143, "DM_NLO_pta130_histos_below0p5_Mt.root");
  plot_signal("Mt", "DM_NLO_Axial_Mx-10_Mv-100_pta130", 9.359e-01, 32922, "DM_NLO_pta130_histos_below0p5_Mt.root");
  plot_signal("Mt", "DM_NLO_Axial_Mx-10_Mv-1500_pta130", 4.044e-03, 22182, "DM_NLO_pta130_histos_below0p5_Mt.root");
  plot_signal("Mt", "DM_NLO_Axial_Mx-10_Mv-2000_pta130", 1.143e-03, 42611, "DM_NLO_pta130_histos_below0p5_Mt.root");
  plot_signal("Mt", "DM_NLO_Axial_Mx-10_Mv-500_pta130", 1.057e-01, 36568, "DM_NLO_pta130_histos_below0p5_Mt.root");
  plot_signal("Mt", "DM_NLO_Axial_Mx-10_Mv-50_pta130", 1.474e+00, 45184, "DM_NLO_pta130_histos_below0p5_Mt.root");
  plot_signal("Mt", "DM_NLO_Axial_Mx-150_Mv-1000_pta130", 1.530e-02, 31254, "DM_NLO_pta130_histos_below0p5_Mt.root");
  plot_signal("Mt", "DM_NLO_Axial_Mx-150_Mv-1500_pta130", 3.884e-03, 38513, "DM_NLO_pta130_histos_below0p5_Mt.root");
  plot_signal("Mt", "DM_NLO_Axial_Mx-150_Mv-2000_pta130", 1.106e-03, 46941, "DM_NLO_pta130_histos_below0p5_Mt.root");
  plot_signal("Mt", "DM_NLO_Axial_Mx-150_Mv-500_pta130", 7.102e-02, 57338, "DM_NLO_pta130_histos_below0p5_Mt.root");
  plot_signal("Mt", "DM_NLO_Axial_Mx-1_Mv-1000_pta130", 1.704e-02, 44497, "DM_NLO_pta130_histos_below0p5_Mt.root");
  plot_signal("Mt", "DM_NLO_Axial_Mx-1_Mv-100_pta130", 9.714e-01, 46369, "DM_NLO_pta130_histos_below0p5_Mt.root");
  plot_signal("Mt", "DM_NLO_Axial_Mx-1_Mv-1500_pta130", 4.032e-03, 45043, "DM_NLO_pta130_histos_below0p5_Mt.root");
  plot_signal("Mt", "DM_NLO_Axial_Mx-1_Mv-50_pta130", 1.664e+00, 35464, "DM_NLO_pta130_histos_below0p5_Mt.root");
  plot_signal("Mt", "DM_NLO_Axial_Mx-40_Mv-100_pta130", 3.718e-01, 50035, "DM_NLO_pta130_histos_below0p5_Mt.root");
  plot_signal("Mt", "DM_NLO_Axial_Mx-490_Mv-1000_pta130", 5.865e-04, 35380, "DM_NLO_pta130_histos_below0p5_Mt.root");
  plot_signal("Mt", "DM_NLO_Axial_Mx-500_Mv-1500_pta130", 2.200e-03, 40265, "DM_NLO_pta130_histos_below0p5_Mt.root");
  plot_signal("Mt", "DM_NLO_Axial_Mx-500_Mv-2000_pta130", 8.270e-04, 33174, "DM_NLO_pta130_histos_below0p5_Mt.root");
  plot_signal("Mt", "DM_NLO_Axial_Mx-50_Mv-1500_pta130", 4.038e-03, 42700, "DM_NLO_pta130_histos_below0p5_Mt.root");
  plot_signal("Mt", "DM_NLO_Axial_Mx-50_Mv-2000_pta130", 1.132e-03, 56252, "DM_NLO_pta130_histos_below0p5_Mt.root");
  plot_signal("Mt", "DM_NLO_Axial_Mx-50_Mv-500_pta130", 1.018e-01, 30526, "DM_NLO_pta130_histos_below0p5_Mt.root");
  plot_signal("Mt", "DM_NLO_Vector_Mx-10_Mv-1000_pta130", 1.664e-02, 39215, "DM_NLO_pta130_histos_below0p5_Mt.root");
  plot_signal("Mt", "DM_NLO_Vector_Mx-10_Mv-100_pta130", 9.464e-01, 49324, "DM_NLO_pta130_histos_below0p5_Mt.root");
  // plot_signal("Mt", "DM_NLO_Vector_Mx-10_Mv-1500_pta130", XSEC_NOT_SET, 415, "DM_NLO_pta130_histos_below0p5_Mt.root");
  plot_signal("Mt", "DM_NLO_Vector_Mx-10_Mv-2000_pta130", 1.134e-03, 41602, "DM_NLO_pta130_histos_below0p5_Mt.root");
  plot_signal("Mt", "DM_NLO_Vector_Mx-10_Mv-500_pta130", 9.890e-02, 42281, "DM_NLO_pta130_histos_below0p5_Mt.root");
  plot_signal("Mt", "DM_NLO_Vector_Mx-150_Mv-1000_pta130", 1.690e-02, 49272, "DM_NLO_pta130_histos_below0p5_Mt.root");
  // plot_signal("Mt", "DM_NLO_Vector_Mx-150_Mv-2000_pta130", XSEC_NOT_SET, 32572, "DM_NLO_pta130_histos_below0p5_Mt.root");
  // plot_signal("Mt", "DM_NLO_Vector_Mx-150_Mv-500_pta130", XSEC_NOT_SET, 110, "DM_NLO_pta130_histos_below0p5_Mt.root");
  plot_signal("Mt", "DM_NLO_Vector_Mx-1_Mv-1000_pta130", 1.664e-02, 42278, "DM_NLO_pta130_histos_below0p5_Mt.root");
  plot_signal("Mt", "DM_NLO_Vector_Mx-1_Mv-100_pta130", 9.783e-01, 29130, "DM_NLO_pta130_histos_below0p5_Mt.root");
  plot_signal("Mt", "DM_NLO_Vector_Mx-1_Mv-1500_pta130", 3.968e-03, 36697, "DM_NLO_pta130_histos_below0p5_Mt.root");
  plot_signal("Mt", "DM_NLO_Vector_Mx-1_Mv-2000_pta130", 1.132e-03, 33436, "DM_NLO_pta130_histos_below0p5_Mt.root");
  plot_signal("Mt", "DM_NLO_Vector_Mx-1_Mv-500_pta130", 1.001e-01, 47448, "DM_NLO_pta130_histos_below0p5_Mt.root");
  plot_signal("Mt", "DM_NLO_Vector_Mx-1_Mv-50_pta130", 1.678e+00, 41448, "DM_NLO_pta130_histos_below0p5_Mt.root");
  plot_signal("Mt", "DM_NLO_Vector_Mx-40_Mv-100_pta130", 8.362e-01, 48583, "DM_NLO_pta130_histos_below0p5_Mt.root");
  plot_signal("Mt", "DM_NLO_Vector_Mx-490_Mv-1000_pta130", 6.709e-03, 38429, "DM_NLO_pta130_histos_below0p5_Mt.root");
  plot_signal("Mt", "DM_NLO_Vector_Mx-500_Mv-1500_pta130", 3.620e-03, 25643, "DM_NLO_pta130_histos_below0p5_Mt.root");
  plot_signal("Mt", "DM_NLO_Vector_Mx-500_Mv-2000_pta130", 1.071e-03, 42904, "DM_NLO_pta130_histos_below0p5_Mt.root");
  plot_signal("Mt", "DM_NLO_Vector_Mx-50_Mv-1000_pta130", 1.705e-02, 43718, "DM_NLO_pta130_histos_below0p5_Mt.root");
  plot_signal("Mt", "DM_NLO_Vector_Mx-50_Mv-2000_pta130", 1.144e-03, 43491, "DM_NLO_pta130_histos_below0p5_Mt.root");
  
  // TFile* f_signal_NLO_histos_Pt = new TFile("DM_NLO_histos_below0p5_Pt.root", "RECREATE");
  ...
  // TFile* f_signal_NLO_histos_MET = new TFile("DM_NLO_histos_below0p5_MET.root", "RECREATE");
  ...
  // TFile* f_signal_NLO_histos_Mt = new TFile("DM_NLO_histos_below0p5_Mt.root", "RECREATE");
  ...
  TFile* f_signal_LO_histos_Pt = new TFile("DM_LO_histos_below0p5_Pt.root", "RECREATE");
  f_signal_LO_histos_Pt->Close();
  plot_signal("Photon_Et_range", "DM_LO_AV_Mx-1000_Mv-10000", 1.572e-08, 49997, "DM_LO_histos_below0p5_Pt.root");
  plot_signal("Photon_Et_range", "DM_LO_AV_Mx-1000_Mv-1000", 1.830e-06, 50000, "DM_LO_histos_below0p5_Pt.root");
  plot_signal("Photon_Et_range", "DM_LO_AV_Mx-1000_Mv-10", 1.344e-06, 49999, "DM_LO_histos_below0p5_Pt.root");
  plot_signal("Photon_Et_range", "DM_LO_AV_Mx-1000_Mv-1995", 1.649e-05, 14198, "DM_LO_histos_below0p5_Pt.root");
  plot_signal("Photon_Et_range", "DM_LO_AV_Mx-10_Mv-10000", 1.217e-07, 49998, "DM_LO_histos_below0p5_Pt.root");
  plot_signal("Photon_Et_range", "DM_LO_AV_Mx-10_Mv-100", 3.776e-01, 50000, "DM_LO_histos_below0p5_Pt.root");
  plot_signal("Photon_Et_range", "DM_LO_AV_Mx-10_Mv-10", 2.898e-02, 800, "DM_LO_histos_below0p5_Pt.root");
  plot_signal("Photon_Et_range", "DM_LO_AV_Mx-10_Mv-15", 3.174e-02, 50000, "DM_LO_histos_below0p5_Pt.root");
  plot_signal("Photon_Et_range", "DM_LO_AV_Mx-10_Mv-50", 3.952e-01, 49999, "DM_LO_histos_below0p5_Pt.root");
  plot_signal("Photon_Et_range", "DM_LO_AV_Mx-150_Mv-10000", 1.076e-07, 50000, "DM_LO_histos_below0p5_Pt.root");
  plot_signal("Photon_Et_range", "DM_LO_AV_Mx-150_Mv-1000", 1.349e-02, 26800, "DM_LO_histos_below0p5_Pt.root");
  plot_signal("Photon_Et_range", "DM_LO_AV_Mx-150_Mv-10", 1.284e-03, 49998, "DM_LO_histos_below0p5_Pt.root");
  plot_signal("Photon_Et_range", "DM_LO_AV_Mx-150_Mv-200", 1.800e-03, 49200, "DM_LO_histos_below0p5_Pt.root");
  plot_signal("Photon_Et_range", "DM_LO_AV_Mx-150_Mv-295", 4.456e-03, 49999, "DM_LO_histos_below0p5_Pt.root");
  plot_signal("Photon_Et_range", "DM_LO_AV_Mx-150_Mv-500", 5.312e-02, 49997, "DM_LO_histos_below0p5_Pt.root");
  plot_signal("Photon_Et_range", "DM_LO_AV_Mx-1_Mv-10000", 1.218e-07, 49999, "DM_LO_histos_below0p5_Pt.root");
  plot_signal("Photon_Et_range", "DM_LO_AV_Mx-1_Mv-1000", 1.465e-02, 49997, "DM_LO_histos_below0p5_Pt.root");
  plot_signal("Photon_Et_range", "DM_LO_AV_Mx-1_Mv-100", 3.876e-01, 50000, "DM_LO_histos_below0p5_Pt.root");
  plot_signal("Photon_Et_range", "DM_LO_AV_Mx-1_Mv-10", 5.202e-01, 50000, "DM_LO_histos_below0p5_Pt.root");
  plot_signal("Photon_Et_range", "DM_LO_AV_Mx-1_Mv-2000", 1.213e-03, 50000, "DM_LO_histos_below0p5_Pt.root");
  plot_signal("Photon_Et_range", "DM_LO_AV_Mx-1_Mv-200", 2.681e-01, 49999, "DM_LO_histos_below0p5_Pt.root");
  plot_signal("Photon_Et_range", "DM_LO_AV_Mx-1_Mv-20", 4.870e-01, 49198, "DM_LO_histos_below0p5_Pt.root");
  plot_signal("Photon_Et_range", "DM_LO_AV_Mx-1_Mv-300", 1.783e-01, 50000, "DM_LO_histos_below0p5_Pt.root");
  plot_signal("Photon_Et_range", "DM_LO_AV_Mx-1_Mv-50", 4.468e-01, 49999, "DM_LO_histos_below0p5_Pt.root");
  plot_signal("Photon_Et_range", "DM_LO_AV_Mx-500_Mv-10000", 5.267e-08, 49999, "DM_LO_histos_below0p5_Pt.root");
  plot_signal("Photon_Et_range", "DM_LO_AV_Mx-500_Mv-10", 3.674e-05, 49999, "DM_LO_histos_below0p5_Pt.root");
  plot_signal("Photon_Et_range", "DM_LO_AV_Mx-500_Mv-2000", 8.975e-04, 50000, "DM_LO_histos_below0p5_Pt.root");
  plot_signal("Photon_Et_range", "DM_LO_AV_Mx-500_Mv-500", 4.725e-05, 49999, "DM_LO_histos_below0p5_Pt.root");
  plot_signal("Photon_Et_range", "DM_LO_AV_Mx-500_Mv-995", 2.678e-04, 48799, "DM_LO_histos_below0p5_Pt.root");
  plot_signal("Photon_Et_range", "DM_LO_AV_Mx-50_Mv-10000", 1.198e-07, 50000, "DM_LO_histos_below0p5_Pt.root");
  plot_signal("Photon_Et_range", "DM_LO_AV_Mx-50_Mv-10", 7.734e-03, 2400, "DM_LO_histos_below0p5_Pt.root");
  plot_signal("Photon_Et_range", "DM_LO_AV_Mx-50_Mv-200", 2.144e-01, 50000, "DM_LO_histos_below0p5_Pt.root");
  plot_signal("Photon_Et_range", "DM_LO_AV_Mx-50_Mv-300", 1.631e-01, 48798, "DM_LO_histos_below0p5_Pt.root");
  plot_signal("Photon_Et_range", "DM_LO_AV_Mx-50_Mv-50", 8.656e-03, 49998, "DM_LO_histos_below0p5_Pt.root");
  plot_signal("Photon_Et_range", "DM_LO_AV_Mx-50_Mv-95", 1.482e-02, 49198, "DM_LO_histos_below0p5_Pt.root");
  plot_signal("Photon_Et_range", "DM_LO_V_Mx-1000_Mv-10000", 3.499e-08, 48399, "DM_LO_histos_below0p5_Pt.root");
  plot_signal("Photon_Et_range", "DM_LO_V_Mx-1000_Mv-1000", 7.679e-06, 49196, "DM_LO_histos_below0p5_Pt.root");
  plot_signal("Photon_Et_range", "DM_LO_V_Mx-1000_Mv-10", 5.262e-06, 4000, "DM_LO_histos_below0p5_Pt.root");
  plot_signal("Photon_Et_range", "DM_LO_V_Mx-1000_Mv-1995", 2.533e-04, 50000, "DM_LO_histos_below0p5_Pt.root");
  plot_signal("Photon_Et_range", "DM_LO_V_Mx-10_Mv-10000", 1.216e-07, 49998, "DM_LO_histos_below0p5_Pt.root");
  plot_signal("Photon_Et_range", "DM_LO_V_Mx-10_Mv-100", 3.885e-01, 49998, "DM_LO_histos_below0p5_Pt.root");
  plot_signal("Photon_Et_range", "DM_LO_V_Mx-10_Mv-10", 3.781e-02, 50000, "DM_LO_histos_below0p5_Pt.root");
  plot_signal("Photon_Et_range", "DM_LO_V_Mx-10_Mv-15", 4.527e-02, 49199, "DM_LO_histos_below0p5_Pt.root");
  plot_signal("Photon_Et_range", "DM_LO_V_Mx-10_Mv-50", 4.422e-01, 49999, "DM_LO_histos_below0p5_Pt.root");
  plot_signal("Photon_Et_range", "DM_LO_V_Mx-150_Mv-10000", 1.195e-07, 49999, "DM_LO_histos_below0p5_Pt.root");
  plot_signal("Photon_Et_range", "DM_LO_V_Mx-150_Mv-1000", 1.437e-02, 49999, "DM_LO_histos_below0p5_Pt.root");
  plot_signal("Photon_Et_range", "DM_LO_V_Mx-150_Mv-10", 2.668e-03, 50000, "DM_LO_histos_below0p5_Pt.root");
  plot_signal("Photon_Et_range", "DM_LO_V_Mx-150_Mv-200", 4.398e-03, 49999, "DM_LO_histos_below0p5_Pt.root");
  plot_signal("Photon_Et_range", "DM_LO_V_Mx-150_Mv-295", 2.901e-02, 49999, "DM_LO_histos_below0p5_Pt.root");
  plot_signal("Photon_Et_range", "DM_LO_V_Mx-150_Mv-500", 7.160e-02, 49999, "DM_LO_histos_below0p5_Pt.root");
  plot_signal("Photon_Et_range", "DM_LO_V_Mx-1_Mv-10000", 1.222e-07, 49399, "DM_LO_histos_below0p5_Pt.root");
  plot_signal("Photon_Et_range", "DM_LO_V_Mx-1_Mv-1000", 1.446e-02, 49999, "DM_LO_histos_below0p5_Pt.root");
  plot_signal("Photon_Et_range", "DM_LO_V_Mx-1_Mv-100", 3.877e-01, 41000, "DM_LO_histos_below0p5_Pt.root");
  plot_signal("Photon_Et_range", "DM_LO_V_Mx-1_Mv-10", 5.114e-01, 50000, "DM_LO_histos_below0p5_Pt.root");
  plot_signal("Photon_Et_range", "DM_LO_V_Mx-1_Mv-2000", 1.207e-03, 47599, "DM_LO_histos_below0p5_Pt.root");
  plot_signal("Photon_Et_range", "DM_LO_V_Mx-1_Mv-200", 2.683e-01, 49997, "DM_LO_histos_below0p5_Pt.root");
  plot_signal("Photon_Et_range", "DM_LO_V_Mx-1_Mv-20", 4.752e-01, 49998, "DM_LO_histos_below0p5_Pt.root");
  plot_signal("Photon_Et_range", "DM_LO_V_Mx-1_Mv-300", 1.785e-01, 50000, "DM_LO_histos_below0p5_Pt.root");
  plot_signal("Photon_Et_range", "DM_LO_V_Mx-1_Mv-500", 7.464e-02, 49998, "DM_LO_histos_below0p5_Pt.root");
  plot_signal("Photon_Et_range", "DM_LO_V_Mx-1_Mv-50", 4.451e-01, 49400, "DM_LO_histos_below0p5_Pt.root");
  plot_signal("Photon_Et_range", "DM_LO_V_Mx-500_Mv-10000", 8.307e-08, 50000, "DM_LO_histos_below0p5_Pt.root");
  plot_signal("Photon_Et_range", "DM_LO_V_Mx-500_Mv-10", 1.087e-04, 50000, "DM_LO_histos_below0p5_Pt.root");
  plot_signal("Photon_Et_range", "DM_LO_V_Mx-500_Mv-2000", 1.152e-03, 50000, "DM_LO_histos_below0p5_Pt.root");
  plot_signal("Photon_Et_range", "DM_LO_V_Mx-500_Mv-500", 1.510e-04, 48400, "DM_LO_histos_below0p5_Pt.root");
  plot_signal("Photon_Et_range", "DM_LO_V_Mx-500_Mv-995", 3.136e-03, 47600, "DM_LO_histos_below0p5_Pt.root");
  plot_signal("Photon_Et_range", "DM_LO_V_Mx-50_Mv-10000", 1.223e-07, 49998, "DM_LO_histos_below0p5_Pt.root");
  plot_signal("Photon_Et_range", "DM_LO_V_Mx-50_Mv-200", 2.646e-01, 49999, "DM_LO_histos_below0p5_Pt.root");
  plot_signal("Photon_Et_range", "DM_LO_V_Mx-50_Mv-300", 1.776e-01, 49997, "DM_LO_histos_below0p5_Pt.root");
  plot_signal("Photon_Et_range", "DM_LO_V_Mx-50_Mv-50", 1.464e-02, 49998, "DM_LO_histos_below0p5_Pt.root");
  plot_signal("Photon_Et_range", "DM_LO_V_Mx-50_Mv-95", 4.502e-02, 50000, "DM_LO_histos_below0p5_Pt.root");

  TFile* f_signal_LO_histos_MET = new TFile("DM_LO_histos_below0p5_MET.root", "RECREATE");
  f_signal_LO_histos_MET->Close();
  plot_signal("pfMET", "DM_LO_AV_Mx-1000_Mv-10000", 1.572e-08, 49997, "DM_LO_histos_below0p5_MET.root");
  plot_signal("pfMET", "DM_LO_AV_Mx-1000_Mv-1000", 1.830e-06, 50000, "DM_LO_histos_below0p5_MET.root");
  plot_signal("pfMET", "DM_LO_AV_Mx-1000_Mv-10", 1.344e-06, 49999, "DM_LO_histos_below0p5_MET.root");
  plot_signal("pfMET", "DM_LO_AV_Mx-1000_Mv-1995", 1.649e-05, 14198, "DM_LO_histos_below0p5_MET.root");
  plot_signal("pfMET", "DM_LO_AV_Mx-10_Mv-10000", 1.217e-07, 49998, "DM_LO_histos_below0p5_MET.root");
  plot_signal("pfMET", "DM_LO_AV_Mx-10_Mv-100", 3.776e-01, 50000, "DM_LO_histos_below0p5_MET.root");
  plot_signal("pfMET", "DM_LO_AV_Mx-10_Mv-10", 2.898e-02, 800, "DM_LO_histos_below0p5_MET.root");
  plot_signal("pfMET", "DM_LO_AV_Mx-10_Mv-15", 3.174e-02, 50000, "DM_LO_histos_below0p5_MET.root");
  plot_signal("pfMET", "DM_LO_AV_Mx-10_Mv-50", 3.952e-01, 49999, "DM_LO_histos_below0p5_MET.root");
  plot_signal("pfMET", "DM_LO_AV_Mx-150_Mv-10000", 1.076e-07, 50000, "DM_LO_histos_below0p5_MET.root");
  plot_signal("pfMET", "DM_LO_AV_Mx-150_Mv-1000", 1.349e-02, 26800, "DM_LO_histos_below0p5_MET.root");
  plot_signal("pfMET", "DM_LO_AV_Mx-150_Mv-10", 1.284e-03, 49998, "DM_LO_histos_below0p5_MET.root");
  plot_signal("pfMET", "DM_LO_AV_Mx-150_Mv-200", 1.800e-03, 49200, "DM_LO_histos_below0p5_MET.root");
  plot_signal("pfMET", "DM_LO_AV_Mx-150_Mv-295", 4.456e-03, 49999, "DM_LO_histos_below0p5_MET.root");
  plot_signal("pfMET", "DM_LO_AV_Mx-150_Mv-500", 5.312e-02, 49997, "DM_LO_histos_below0p5_MET.root");
  plot_signal("pfMET", "DM_LO_AV_Mx-1_Mv-10000", 1.218e-07, 49999, "DM_LO_histos_below0p5_MET.root");
  plot_signal("pfMET", "DM_LO_AV_Mx-1_Mv-1000", 1.465e-02, 49997, "DM_LO_histos_below0p5_MET.root");
  plot_signal("pfMET", "DM_LO_AV_Mx-1_Mv-100", 3.876e-01, 50000, "DM_LO_histos_below0p5_MET.root");
  plot_signal("pfMET", "DM_LO_AV_Mx-1_Mv-10", 5.202e-01, 50000, "DM_LO_histos_below0p5_MET.root");
  plot_signal("pfMET", "DM_LO_AV_Mx-1_Mv-2000", 1.213e-03, 50000, "DM_LO_histos_below0p5_MET.root");
  plot_signal("pfMET", "DM_LO_AV_Mx-1_Mv-200", 2.681e-01, 49999, "DM_LO_histos_below0p5_MET.root");
  plot_signal("pfMET", "DM_LO_AV_Mx-1_Mv-20", 4.870e-01, 49198, "DM_LO_histos_below0p5_MET.root");
  plot_signal("pfMET", "DM_LO_AV_Mx-1_Mv-300", 1.783e-01, 50000, "DM_LO_histos_below0p5_MET.root");
  plot_signal("pfMET", "DM_LO_AV_Mx-1_Mv-50", 4.468e-01, 49999, "DM_LO_histos_below0p5_MET.root");
  plot_signal("pfMET", "DM_LO_AV_Mx-500_Mv-10000", 5.267e-08, 49999, "DM_LO_histos_below0p5_MET.root");
  plot_signal("pfMET", "DM_LO_AV_Mx-500_Mv-10", 3.674e-05, 49999, "DM_LO_histos_below0p5_MET.root");
  plot_signal("pfMET", "DM_LO_AV_Mx-500_Mv-2000", 8.975e-04, 50000, "DM_LO_histos_below0p5_MET.root");
  plot_signal("pfMET", "DM_LO_AV_Mx-500_Mv-500", 4.725e-05, 49999, "DM_LO_histos_below0p5_MET.root");
  plot_signal("pfMET", "DM_LO_AV_Mx-500_Mv-995", 2.678e-04, 48799, "DM_LO_histos_below0p5_MET.root");
  plot_signal("pfMET", "DM_LO_AV_Mx-50_Mv-10000", 1.198e-07, 50000, "DM_LO_histos_below0p5_MET.root");
  plot_signal("pfMET", "DM_LO_AV_Mx-50_Mv-10", 7.734e-03, 2400, "DM_LO_histos_below0p5_MET.root");
  plot_signal("pfMET", "DM_LO_AV_Mx-50_Mv-200", 2.144e-01, 50000, "DM_LO_histos_below0p5_MET.root");
  plot_signal("pfMET", "DM_LO_AV_Mx-50_Mv-300", 1.631e-01, 48798, "DM_LO_histos_below0p5_MET.root");
  plot_signal("pfMET", "DM_LO_AV_Mx-50_Mv-50", 8.656e-03, 49998, "DM_LO_histos_below0p5_MET.root");
  plot_signal("pfMET", "DM_LO_AV_Mx-50_Mv-95", 1.482e-02, 49198, "DM_LO_histos_below0p5_MET.root");
  plot_signal("pfMET", "DM_LO_V_Mx-1000_Mv-10000", 3.499e-08, 48399, "DM_LO_histos_below0p5_MET.root");
  plot_signal("pfMET", "DM_LO_V_Mx-1000_Mv-1000", 7.679e-06, 49196, "DM_LO_histos_below0p5_MET.root");
  plot_signal("pfMET", "DM_LO_V_Mx-1000_Mv-10", 5.262e-06, 4000, "DM_LO_histos_below0p5_MET.root");
  plot_signal("pfMET", "DM_LO_V_Mx-1000_Mv-1995", 2.533e-04, 50000, "DM_LO_histos_below0p5_MET.root");
  plot_signal("pfMET", "DM_LO_V_Mx-10_Mv-10000", 1.216e-07, 49998, "DM_LO_histos_below0p5_MET.root");
  plot_signal("pfMET", "DM_LO_V_Mx-10_Mv-100", 3.885e-01, 49998, "DM_LO_histos_below0p5_MET.root");
  plot_signal("pfMET", "DM_LO_V_Mx-10_Mv-10", 3.781e-02, 50000, "DM_LO_histos_below0p5_MET.root");
  plot_signal("pfMET", "DM_LO_V_Mx-10_Mv-15", 4.527e-02, 49199, "DM_LO_histos_below0p5_MET.root");
  plot_signal("pfMET", "DM_LO_V_Mx-10_Mv-50", 4.422e-01, 49999, "DM_LO_histos_below0p5_MET.root");
  plot_signal("pfMET", "DM_LO_V_Mx-150_Mv-10000", 1.195e-07, 49999, "DM_LO_histos_below0p5_MET.root");
  plot_signal("pfMET", "DM_LO_V_Mx-150_Mv-1000", 1.437e-02, 49999, "DM_LO_histos_below0p5_MET.root");
  plot_signal("pfMET", "DM_LO_V_Mx-150_Mv-10", 2.668e-03, 50000, "DM_LO_histos_below0p5_MET.root");
  plot_signal("pfMET", "DM_LO_V_Mx-150_Mv-200", 4.398e-03, 49999, "DM_LO_histos_below0p5_MET.root");
  plot_signal("pfMET", "DM_LO_V_Mx-150_Mv-295", 2.901e-02, 49999, "DM_LO_histos_below0p5_MET.root");
  plot_signal("pfMET", "DM_LO_V_Mx-150_Mv-500", 7.160e-02, 49999, "DM_LO_histos_below0p5_MET.root");
  plot_signal("pfMET", "DM_LO_V_Mx-1_Mv-10000", 1.222e-07, 49399, "DM_LO_histos_below0p5_MET.root");
  plot_signal("pfMET", "DM_LO_V_Mx-1_Mv-1000", 1.446e-02, 49999, "DM_LO_histos_below0p5_MET.root");
  plot_signal("pfMET", "DM_LO_V_Mx-1_Mv-100", 3.877e-01, 41000, "DM_LO_histos_below0p5_MET.root");
  plot_signal("pfMET", "DM_LO_V_Mx-1_Mv-10", 5.114e-01, 50000, "DM_LO_histos_below0p5_MET.root");
  plot_signal("pfMET", "DM_LO_V_Mx-1_Mv-2000", 1.207e-03, 47599, "DM_LO_histos_below0p5_MET.root");
  plot_signal("pfMET", "DM_LO_V_Mx-1_Mv-200", 2.683e-01, 49997, "DM_LO_histos_below0p5_MET.root");
  plot_signal("pfMET", "DM_LO_V_Mx-1_Mv-20", 4.752e-01, 49998, "DM_LO_histos_below0p5_MET.root");
  plot_signal("pfMET", "DM_LO_V_Mx-1_Mv-300", 1.785e-01, 50000, "DM_LO_histos_below0p5_MET.root");
  plot_signal("pfMET", "DM_LO_V_Mx-1_Mv-500", 7.464e-02, 49998, "DM_LO_histos_below0p5_MET.root");
  plot_signal("pfMET", "DM_LO_V_Mx-1_Mv-50", 4.451e-01, 49400, "DM_LO_histos_below0p5_MET.root");
  plot_signal("pfMET", "DM_LO_V_Mx-500_Mv-10000", 8.307e-08, 50000, "DM_LO_histos_below0p5_MET.root");
  plot_signal("pfMET", "DM_LO_V_Mx-500_Mv-10", 1.087e-04, 50000, "DM_LO_histos_below0p5_MET.root");
  plot_signal("pfMET", "DM_LO_V_Mx-500_Mv-2000", 1.152e-03, 50000, "DM_LO_histos_below0p5_MET.root");
  plot_signal("pfMET", "DM_LO_V_Mx-500_Mv-500", 1.510e-04, 48400, "DM_LO_histos_below0p5_MET.root");
  plot_signal("pfMET", "DM_LO_V_Mx-500_Mv-995", 3.136e-03, 47600, "DM_LO_histos_below0p5_MET.root");
  plot_signal("pfMET", "DM_LO_V_Mx-50_Mv-10000", 1.223e-07, 49998, "DM_LO_histos_below0p5_MET.root");
  plot_signal("pfMET", "DM_LO_V_Mx-50_Mv-200", 2.646e-01, 49999, "DM_LO_histos_below0p5_MET.root");
  plot_signal("pfMET", "DM_LO_V_Mx-50_Mv-300", 1.776e-01, 49997, "DM_LO_histos_below0p5_MET.root");
  plot_signal("pfMET", "DM_LO_V_Mx-50_Mv-50", 1.464e-02, 49998, "DM_LO_histos_below0p5_MET.root");
  plot_signal("pfMET", "DM_LO_V_Mx-50_Mv-95", 4.502e-02, 50000, "DM_LO_histos_below0p5_MET.root");

  TFile* f_signal_LO_histos_Mt = new TFile("DM_LO_histos_below0p5_Mt.root", "RECREATE");
  f_signal_LO_histos_Mt->Close();
  plot_signal("Mt", "DM_LO_AV_Mx-1000_Mv-10000", 1.572e-08, 49997, "DM_LO_histos_below0p5_Mt.root");
  plot_signal("Mt", "DM_LO_AV_Mx-1000_Mv-1000", 1.830e-06, 50000, "DM_LO_histos_below0p5_Mt.root");
  plot_signal("Mt", "DM_LO_AV_Mx-1000_Mv-10", 1.344e-06, 49999, "DM_LO_histos_below0p5_Mt.root");
  plot_signal("Mt", "DM_LO_AV_Mx-1000_Mv-1995", 1.649e-05, 14198, "DM_LO_histos_below0p5_Mt.root");
  plot_signal("Mt", "DM_LO_AV_Mx-10_Mv-10000", 1.217e-07, 49998, "DM_LO_histos_below0p5_Mt.root");
  plot_signal("Mt", "DM_LO_AV_Mx-10_Mv-100", 3.776e-01, 50000, "DM_LO_histos_below0p5_Mt.root");
  plot_signal("Mt", "DM_LO_AV_Mx-10_Mv-10", 2.898e-02, 800, "DM_LO_histos_below0p5_Mt.root");
  plot_signal("Mt", "DM_LO_AV_Mx-10_Mv-15", 3.174e-02, 50000, "DM_LO_histos_below0p5_Mt.root");
  plot_signal("Mt", "DM_LO_AV_Mx-10_Mv-50", 3.952e-01, 49999, "DM_LO_histos_below0p5_Mt.root");
  plot_signal("Mt", "DM_LO_AV_Mx-150_Mv-10000", 1.076e-07, 50000, "DM_LO_histos_below0p5_Mt.root");
  plot_signal("Mt", "DM_LO_AV_Mx-150_Mv-1000", 1.349e-02, 26800, "DM_LO_histos_below0p5_Mt.root");
  plot_signal("Mt", "DM_LO_AV_Mx-150_Mv-10", 1.284e-03, 49998, "DM_LO_histos_below0p5_Mt.root");
  plot_signal("Mt", "DM_LO_AV_Mx-150_Mv-200", 1.800e-03, 49200, "DM_LO_histos_below0p5_Mt.root");
  plot_signal("Mt", "DM_LO_AV_Mx-150_Mv-295", 4.456e-03, 49999, "DM_LO_histos_below0p5_Mt.root");
  plot_signal("Mt", "DM_LO_AV_Mx-150_Mv-500", 5.312e-02, 49997, "DM_LO_histos_below0p5_Mt.root");
  plot_signal("Mt", "DM_LO_AV_Mx-1_Mv-10000", 1.218e-07, 49999, "DM_LO_histos_below0p5_Mt.root");
  plot_signal("Mt", "DM_LO_AV_Mx-1_Mv-1000", 1.465e-02, 49997, "DM_LO_histos_below0p5_Mt.root");
  plot_signal("Mt", "DM_LO_AV_Mx-1_Mv-100", 3.876e-01, 50000, "DM_LO_histos_below0p5_Mt.root");
  plot_signal("Mt", "DM_LO_AV_Mx-1_Mv-10", 5.202e-01, 50000, "DM_LO_histos_below0p5_Mt.root");
  plot_signal("Mt", "DM_LO_AV_Mx-1_Mv-2000", 1.213e-03, 50000, "DM_LO_histos_below0p5_Mt.root");
  plot_signal("Mt", "DM_LO_AV_Mx-1_Mv-200", 2.681e-01, 49999, "DM_LO_histos_below0p5_Mt.root");
  plot_signal("Mt", "DM_LO_AV_Mx-1_Mv-20", 4.870e-01, 49198, "DM_LO_histos_below0p5_Mt.root");
  plot_signal("Mt", "DM_LO_AV_Mx-1_Mv-300", 1.783e-01, 50000, "DM_LO_histos_below0p5_Mt.root");
  plot_signal("Mt", "DM_LO_AV_Mx-1_Mv-50", 4.468e-01, 49999, "DM_LO_histos_below0p5_Mt.root");
  plot_signal("Mt", "DM_LO_AV_Mx-500_Mv-10000", 5.267e-08, 49999, "DM_LO_histos_below0p5_Mt.root");
  plot_signal("Mt", "DM_LO_AV_Mx-500_Mv-10", 3.674e-05, 49999, "DM_LO_histos_below0p5_Mt.root");
  plot_signal("Mt", "DM_LO_AV_Mx-500_Mv-2000", 8.975e-04, 50000, "DM_LO_histos_below0p5_Mt.root");
  plot_signal("Mt", "DM_LO_AV_Mx-500_Mv-500", 4.725e-05, 49999, "DM_LO_histos_below0p5_Mt.root");
  plot_signal("Mt", "DM_LO_AV_Mx-500_Mv-995", 2.678e-04, 48799, "DM_LO_histos_below0p5_Mt.root");
  plot_signal("Mt", "DM_LO_AV_Mx-50_Mv-10000", 1.198e-07, 50000, "DM_LO_histos_below0p5_Mt.root");
  plot_signal("Mt", "DM_LO_AV_Mx-50_Mv-10", 7.734e-03, 2400, "DM_LO_histos_below0p5_Mt.root");
  plot_signal("Mt", "DM_LO_AV_Mx-50_Mv-200", 2.144e-01, 50000, "DM_LO_histos_below0p5_Mt.root");
  plot_signal("Mt", "DM_LO_AV_Mx-50_Mv-300", 1.631e-01, 48798, "DM_LO_histos_below0p5_Mt.root");
  plot_signal("Mt", "DM_LO_AV_Mx-50_Mv-50", 8.656e-03, 49998, "DM_LO_histos_below0p5_Mt.root");
  plot_signal("Mt", "DM_LO_AV_Mx-50_Mv-95", 1.482e-02, 49198, "DM_LO_histos_below0p5_Mt.root");
  plot_signal("Mt", "DM_LO_V_Mx-1000_Mv-10000", 3.499e-08, 48399, "DM_LO_histos_below0p5_Mt.root");
  plot_signal("Mt", "DM_LO_V_Mx-1000_Mv-1000", 7.679e-06, 49196, "DM_LO_histos_below0p5_Mt.root");
  plot_signal("Mt", "DM_LO_V_Mx-1000_Mv-10", 5.262e-06, 4000, "DM_LO_histos_below0p5_Mt.root");
  plot_signal("Mt", "DM_LO_V_Mx-1000_Mv-1995", 2.533e-04, 50000, "DM_LO_histos_below0p5_Mt.root");
  plot_signal("Mt", "DM_LO_V_Mx-10_Mv-10000", 1.216e-07, 49998, "DM_LO_histos_below0p5_Mt.root");
  plot_signal("Mt", "DM_LO_V_Mx-10_Mv-100", 3.885e-01, 49998, "DM_LO_histos_below0p5_Mt.root");
  plot_signal("Mt", "DM_LO_V_Mx-10_Mv-10", 3.781e-02, 50000, "DM_LO_histos_below0p5_Mt.root");
  plot_signal("Mt", "DM_LO_V_Mx-10_Mv-15", 4.527e-02, 49199, "DM_LO_histos_below0p5_Mt.root");
  plot_signal("Mt", "DM_LO_V_Mx-10_Mv-50", 4.422e-01, 49999, "DM_LO_histos_below0p5_Mt.root");
  plot_signal("Mt", "DM_LO_V_Mx-150_Mv-10000", 1.195e-07, 49999, "DM_LO_histos_below0p5_Mt.root");
  plot_signal("Mt", "DM_LO_V_Mx-150_Mv-1000", 1.437e-02, 49999, "DM_LO_histos_below0p5_Mt.root");
  plot_signal("Mt", "DM_LO_V_Mx-150_Mv-10", 2.668e-03, 50000, "DM_LO_histos_below0p5_Mt.root");
  plot_signal("Mt", "DM_LO_V_Mx-150_Mv-200", 4.398e-03, 49999, "DM_LO_histos_below0p5_Mt.root");
  plot_signal("Mt", "DM_LO_V_Mx-150_Mv-295", 2.901e-02, 49999, "DM_LO_histos_below0p5_Mt.root");
  plot_signal("Mt", "DM_LO_V_Mx-150_Mv-500", 7.160e-02, 49999, "DM_LO_histos_below0p5_Mt.root");
  plot_signal("Mt", "DM_LO_V_Mx-1_Mv-10000", 1.222e-07, 49399, "DM_LO_histos_below0p5_Mt.root");
  plot_signal("Mt", "DM_LO_V_Mx-1_Mv-1000", 1.446e-02, 49999, "DM_LO_histos_below0p5_Mt.root");
  plot_signal("Mt", "DM_LO_V_Mx-1_Mv-100", 3.877e-01, 41000, "DM_LO_histos_below0p5_Mt.root");
  plot_signal("Mt", "DM_LO_V_Mx-1_Mv-10", 5.114e-01, 50000, "DM_LO_histos_below0p5_Mt.root");
  plot_signal("Mt", "DM_LO_V_Mx-1_Mv-2000", 1.207e-03, 47599, "DM_LO_histos_below0p5_Mt.root");
  plot_signal("Mt", "DM_LO_V_Mx-1_Mv-200", 2.683e-01, 49997, "DM_LO_histos_below0p5_Mt.root");
  plot_signal("Mt", "DM_LO_V_Mx-1_Mv-20", 4.752e-01, 49998, "DM_LO_histos_below0p5_Mt.root");
  plot_signal("Mt", "DM_LO_V_Mx-1_Mv-300", 1.785e-01, 50000, "DM_LO_histos_below0p5_Mt.root");
  plot_signal("Mt", "DM_LO_V_Mx-1_Mv-500", 7.464e-02, 49998, "DM_LO_histos_below0p5_Mt.root");
  plot_signal("Mt", "DM_LO_V_Mx-1_Mv-50", 4.451e-01, 49400, "DM_LO_histos_below0p5_Mt.root");
  plot_signal("Mt", "DM_LO_V_Mx-500_Mv-10000", 8.307e-08, 50000, "DM_LO_histos_below0p5_Mt.root");
  plot_signal("Mt", "DM_LO_V_Mx-500_Mv-10", 1.087e-04, 50000, "DM_LO_histos_below0p5_Mt.root");
  plot_signal("Mt", "DM_LO_V_Mx-500_Mv-2000", 1.152e-03, 50000, "DM_LO_histos_below0p5_Mt.root");
  plot_signal("Mt", "DM_LO_V_Mx-500_Mv-500", 1.510e-04, 48400, "DM_LO_histos_below0p5_Mt.root");
  plot_signal("Mt", "DM_LO_V_Mx-500_Mv-995", 3.136e-03, 47600, "DM_LO_histos_below0p5_Mt.root");
  plot_signal("Mt", "DM_LO_V_Mx-50_Mv-10000", 1.223e-07, 49998, "DM_LO_histos_below0p5_Mt.root");
  plot_signal("Mt", "DM_LO_V_Mx-50_Mv-200", 2.646e-01, 49999, "DM_LO_histos_below0p5_Mt.root");
  plot_signal("Mt", "DM_LO_V_Mx-50_Mv-300", 1.776e-01, 49997, "DM_LO_histos_below0p5_Mt.root");
  plot_signal("Mt", "DM_LO_V_Mx-50_Mv-50", 1.464e-02, 49998, "DM_LO_histos_below0p5_Mt.root");
  plot_signal("Mt", "DM_LO_V_Mx-50_Mv-95", 4.502e-02, 50000, "DM_LO_histos_below0p5_Mt.root");
}