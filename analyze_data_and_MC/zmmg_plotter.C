...
void plot(string histname_string, Double_t leg_xoffset, Double_t leg_yoffset, TString xaxis_title, TString plotname)
{
  ...
  double muon_scale_factor_unc = 0.02; //uncertainty on the square of the muon scale factor
  ...
  TFile *f_data = new TFile("ZmmG_data_all.root");
  ...
  TFile *f_jetfake = new TFile("ZmmG_qcd_all.root");
  ...
  TFile *f_ZllG_130_under300 = new TFile("ZmmG_JESPES_ZLLGJets_130_under300.root");
  // TFile *f_ZllG_130_over300 = new TFile("ZmmG_JESPES_ZLLGJets_130_over300.root");
  TFile *f_ZllG_300 = new TFile("ZmmG_JESPES_ZLLGJets_300.root");
  ...
  if(histname == "Photon_Et_range_4" || histname == "h_photonic_recoil_4" || histname == "h_phoRecoilMt_4"){
    ...
    TString filename = TString("histos_"+xaxis_variable+"_ZmmG_pdfscale_ZLLGJets_130_under300.root");
    TString filename_ext = TString("histos_"+xaxis_variable+"_ZmmG_pdfscale_ZLLGJets_300.root");
    TFile* f_pdfscale_ZllG_130_under300 = new TFile(filename);
    // histo_ZllG_RenUp_130_under300 = (TH1F*)f_pdfscale_ZllG_130_under300->Get("h_ZmmG_pdfscale_ZLLGJets_130_under300_renUp");
    // histo_ZllG_RenDown_130_under300 = (TH1F*)f_pdfscale_ZllG_130_under300->Get("h_ZmmG_pdfscale_ZLLGJets_130_under300_renDown");
    // histo_ZllG_FacUp_130_under300 = (TH1F*)f_pdfscale_ZllG_130_under300->Get("h_ZmmG_pdfscale_ZLLGJets_130_under300_facUp");
    // histo_ZllG_FacDown_130_under300 = (TH1F*)f_pdfscale_ZllG_130_under300->Get("h_ZmmG_pdfscale_ZLLGJets_130_under300_facDown");
    histo_ZllG_PDFUp_130_under300 = (TH1F*)f_pdfscale_ZllG_130_under300->Get("h_ZmmG_pdfscale_ZLLGJets_130_under300_pdfUp");
    histo_ZllG_PDFDown_130_under300 = (TH1F*)f_pdfscale_ZllG_130_under300->Get("h_ZmmG_pdfscale_ZLLGJets_130_under300_pdfDown");
    TFile* f_pdfscale_ZllG_300 = new TFile(filename_ext);
    // histo_ZllG_RenUp_300 = (TH1F*)f_pdfscale_ZllG_300->Get("h_ZmmG_pdfscale_ZLLGJets_300_renUp");
    // histo_ZllG_RenDown_300 = (TH1F*)f_pdfscale_ZllG_300->Get("h_ZmmG_pdfscale_ZLLGJets_300_renDown");
    // histo_ZllG_FacUp_300 = (TH1F*)f_pdfscale_ZllG_300->Get("h_ZmmG_pdfscale_ZLLGJets_300_facUp");
    // histo_ZllG_FacDown_300 = (TH1F*)f_pdfscale_ZllG_300->Get("h_ZmmG_pdfscale_ZLLGJets_300_facDown");
    histo_ZllG_PDFUp_300 = (TH1F*)f_pdfscale_ZllG_300->Get("h_ZmmG_pdfscale_ZLLGJets_300_pdfUp");
    histo_ZllG_PDFDown_300 = (TH1F*)f_pdfscale_ZllG_300->Get("h_ZmmG_pdfscale_ZLLGJets_300_pdfDown");
    // TFile* f_pdfscale_ZllG_130_over300 = new TFile("histos_ZmmG_pdfscale_ZLLGJets_130_over300.root");
    // histo_ZllG_RenUp_130_over300 = (TH1F*)f_pdfscale_ZllG_130_over300->Get("h_ZmmG_pdfscale_ZLLGJets_130_over300_renUp");
    // histo_ZllG_RenDown_130_over300 = (TH1F*)f_pdfscale_ZllG_130_over300->Get("h_ZmmG_pdfscale_ZLLGJets_130_over300_renDown");
    // histo_ZllG_FacUp_130_over300 = (TH1F*)f_pdfscale_ZllG_130_over300->Get("h_ZmmG_pdfscale_ZLLGJets_130_over300_facUp");
    // histo_ZllG_FacDown_130_over300 = (TH1F*)f_pdfscale_ZllG_130_over300->Get("h_ZmmG_pdfscale_ZLLGJets_130_over300_facDown");
    // histo_ZllG_PDFUp_130_over300 = (TH1F*)f_pdfscale_ZllG_130_over300->Get("h_ZmmG_pdfscale_ZLLGJets_130_over300_pdfUp");
    // histo_ZllG_PDFDown_130_over300 = (TH1F*)f_pdfscale_ZllG_130_over300->Get("h_ZmmG_pdfscale_ZLLGJets_130_over300_pdfDown");
  ...
  if(int_ZllG > 0.0)
    err_ZllG = sqrt(int_ZllG_130_under300*int_ZllG_130_under300*((photon_scale_factor_unc*photon_scale_factor_unc)+(muon_scale_factor_unc*muon_scale_factor_unc)+(0.148*int_lumi*scale_factor-int_ZllG_130_under300)/(489423.0*int_ZllG_130_under300))+int_ZllG_300*int_ZllG_300*((photon_scale_factor_unc*photon_scale_factor_unc)+(muon_scale_factor_unc*muon_scale_factor_unc)+(0.0092*int_lumi*scale_factor-int_ZllG_300)/(1707773.0*int_ZllG_300))+(qcdscaleerr_ZllG*qcdscaleerr_ZllG)+(jeserr_ZllG*jeserr_ZllG)+(peserr_ZllG*peserr_ZllG)+(straighterr_ZllG*straighterr_ZllG)+(twistederr_ZllG*twistederr_ZllG)+(gammaerr_ZllG*gammaerr_ZllG)+(pdferr_ZllG*pdferr_ZllG));
  ...
  if(histname == "Photon_Et_range_4"){
    cout<<endl;
    cout<<"int_ZllG: "<<int_ZllG<<endl;
    cout<<"histo_ZllG_combined->Integral(): "<<histo_ZllG_combined->Integral()<<endl;
    cout<<endl;
  }
  ...
  TFile *f_TTG = new TFile("ZmmG_JESPES_TTGJets.root");
  ...
  Float_t err_TTG = 0.0;
  if(int_TTG > 0.0)
    err_TTG = sqrt(int_TTG*int_TTG*((photon_scale_factor_unc*photon_scale_factor_unc)+(muon_scale_factor_unc*muon_scale_factor_unc)+(3.697*int_lumi*scale_factor-int_TTG)/(3170400.0*int_TTG))+(jeserr_TTG*jeserr_TTG)+(peserr_TTG*peserr_TTG));
  ...
  // TFile* f_WWG = new TFile("ZmmG_JESPES_WWG.root");
  ...
  // Float_t err_WWG = 0.0;
  // if(int_WWG > 0.0)
  //   err_WWG = sqrt(int_WWG*int_WWG*((photon_scale_factor_unc*photon_scale_factor_unc)+(muon_scale_factor_unc*muon_scale_factor_unc)+(0.2147*int_lumi*scale_factor-int_WWG)/(827604.0*int_WWG))+(jeserr_WWG*jeserr_WWG)+(peserr_WWG*peserr_WWG));
  ...
  TFile *f_WZ = new TFile("ZmmG_JESPES_WZ.root");
  ...
  Float_t err_WZ = 0.0;
  if(int_WZ > 0.0)
    err_WZ = sqrt(int_WZ*int_WZ*((photon_scale_factor_unc*photon_scale_factor_unc)+(muon_scale_factor_unc*muon_scale_factor_unc)+(66.1*int_lumi*scale_factor-int_WZ)/(2995783.0*int_WZ))+(jeserr_WZ*jeserr_WZ)+(peserr_WZ*peserr_WZ));
  ...
  // TFile *f_ZGGToLLGG = new TFile("ZmmG_JESPES_ZGGToLLGG.root");
  ...
  //   err_ZGGToLLGG = sqrt(int_ZGGToLLGG*int_ZGGToLLGG*((photon_scale_factor_unc*photon_scale_factor_unc)+(muon_scale_factor_unc*muon_scale_factor_unc)+(0.6289*int_lumi*scale_factor-int_ZGGToLLGG)/(731966.0*int_ZGGToLLGG))+(jeserr_ZGGToLLGG*jeserr_ZGGToLLGG)+(peserr_ZGGToLLGG*peserr_ZGGToLLGG)+(phosferr_ZGGToLLGG*phosferr_ZGGToLLGG));
  ...
  // TFile *f_Zll_100to200 = new TFile(TString("ZmmG_JESPES_DYJetsToLL_HT-100to200.root"));
  // TFile *f_Zll_200to400 = new TFile(TString("ZmmG_JESPES_DYJetsToLL_HT-200to400.root"));
  // TFile *f_Zll_400to600 = new TFile(TString("ZmmG_JESPES_DYJetsToLL_HT-400to600.root"));
  // TFile *f_Zll_600to800 = new TFile(TString("ZmmG_JESPES_DYJetsToLL_HT-600to800.root"));
  // TFile *f_Zll_800to1200 = new TFile(TString("ZmmG_JESPES_DYJetsToLL_HT-800to1200.root"));
  // TFile *f_Zll_1200to2500 = new TFile(TString("ZmmG_JESPES_DYJetsToLL_HT-1200to2500.root"));
  // TFile *f_Zll_2500toInf = new TFile(TString("ZmmG_JESPES_DYJetsToLL_HT-2500toInf.root"));
  ...
  if (histname == "Photon_Et_range_4" || histname == "h_photonic_recoil_4" || histname == "h_phoRecoilMt_4")
  {
    TFile* f_ZmmG_histos;
    if(histname == "Photon_Et_range_4")
      f_ZmmG_histos = new TFile("ZmmG_histos_Pt.root","RECREATE");
    else if(histname == "h_photonic_recoil_4")
      f_ZmmG_histos = new TFile("ZmmG_histos_MET.root","RECREATE");
    else if(histname == "h_phoRecoilMt_4")
      f_ZmmG_histos = new TFile("ZmmG_histos_Mt.root","RECREATE");
    f_ZmmG_histos->cd();
    histo_data->Write();
  ...
  if(histname == "Photon_Et_range_4"){
    ...
    cout<<"int_ZllG: "<<int_ZllG<<endl;
    cout<<"histo_ZllG_combined->Integral(): "<<histo_ZllG_combined->Integral()<<endl;
    TFile *f_ZmmG_histos = new TFile("ZmmG_histos_Pt.root");
    TH1F* histo_ZllG_debug = (TH1F*)((TH1F*)f_ZmmG_histos->Get("histo_ZllG_combined"))->Clone("histo_ZllG_debug");
    cout<<"histo_ZllG_debug->Integral(): "<<histo_ZllG_debug->Integral()<<endl;
    f_ZmmG_histos->Close();
    cout<<endl;
  }
  ...
  for(int i = 1; i <= nBins; i++){
    ...
    binerror = sqrt(sum_binerrors_squared+pow(background*photon_scale_factor_unc,2)+pow(background*muon_scale_factor_unc,2)+pow(jeserr,2)+pow(peserr,2)+pow(straighterr_ZllG,2)+pow(twistederr_ZllG,2)+pow(gammaerr_ZllG,2)+pow(renerr,2)+pow(facerr,2)+pow(pdferr,2)+pow(qcdscaleerr_ZllG,2)+pow(jetfakeerr,2));
  ...
  c->SaveAs(TString("zmmg_"+plotname+".png"));
  c->SaveAs(TString("zmmg_"+plotname+".pdf"));
  delete(c);
}
...
//  plotnames.push_back(TString(""));
  ...
  leg_xoffsets.push_back(0.);
  leg_yoffsets.push_back(0.);
  xaxis_titles.push_back(TString("Leading Muon #it{p}_{T} [GeV]"));
  plotnames.push_back(TString("muPtLeading"));

  histnames.push_back("h_leadingLeptonEta");
  leg_xoffsets.push_back(0.15);
  leg_yoffsets.push_back(0.);
  xaxis_titles.push_back(TString("Leading Muon #eta"));
  plotnames.push_back(TString("muEtaLeading"));

  histnames.push_back("h_leadingLeptonPhi");
  leg_xoffsets.push_back(0.);
  leg_yoffsets.push_back(0.);
  xaxis_titles.push_back(TString("Leading Muon #phi"));
  plotnames.push_back(TString("muPhiLeading"));

  histnames.push_back("h_subleadingLeptonPt");
  leg_xoffsets.push_back(0.);
  leg_yoffsets.push_back(0.);
  xaxis_titles.push_back(TString("Subleading Muon #it{p}_{T} [GeV]"));
  plotnames.push_back(TString("muPtSubleading"));

  histnames.push_back("h_subleadingLeptonEta");
  leg_xoffsets.push_back(0.15);
  leg_yoffsets.push_back(0.);
  xaxis_titles.push_back(TString("Subleading Muon #eta"));
  plotnames.push_back(TString("muEtaSubleading"));

  histnames.push_back("h_subleadingLeptonPhi");
  leg_xoffsets.push_back(0.);
  leg_yoffsets.push_back(0.);
  xaxis_titles.push_back(TString("Subleading Muon #phi"));
  plotnames.push_back(TString("muPhiSubleading"));
  
  histnames.push_back("h_dileptonPt");
  leg_xoffsets.push_back(0.);
  leg_yoffsets.push_back(0.);
  xaxis_titles.push_back(TString("Dimuon #it{p}_{T} [GeV]"));
  plotnames.push_back(TString("dimuPt"));
  
  histnames.push_back("h_dileptonM");
  leg_xoffsets.push_back(0.);
  leg_yoffsets.push_back(0.);
  xaxis_titles.push_back(TString("Dimuon Invariant Mass [GeV]"));
  plotnames.push_back(TString("dimuM"));
  ...
  leg_xoffsets.push_back(0.);
  leg_yoffsets.push_back(0.);
  xaxis_titles.push_back(TString("Dimuon #it{p}_{T} / pfMET"));
  plotnames.push_back(TString("dimuPtOverpfMET"));
  ...
  leg_xoffsets.push_back(0.);
  leg_yoffsets.push_back(0.);
  xaxis_titles.push_back(TString("#Delta#phi(Leading Mu,Subleading Mu)"));
  plotnames.push_back(TString("dPhiLeadingMuSubleadingMu"));
