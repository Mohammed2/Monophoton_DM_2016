...
void plot(string histname_string, Double_t leg_xoffset, Double_t leg_yoffset, TString xaxis_title, TString plotname)
{
  ...
  TFile* f_WG = new TFile("WmnG_JESPES_WGJets.root");
  ...
  TFile* f_WG_ext = new TFile("WmnG_JESPES_WGJets_ext.root");
  ...
  TFile* f_WG_mitExt = new TFile("WmnG_JESPES_WGJets_mitExt.root");
  ...
  if(histname == "Photon_Et_range_4" || histname == "pfMET_4" || histname == "Mt_4"){
    ...
    TString filename = TString("histos_"+xaxis_variable+"_WmnG_pdfscale_WGJets.root");
    TString filename_ext = TString("histos_"+xaxis_variable+"_WmnG_pdfscale_WGJets_ext.root");
    TString filename_mitExt = TString("histos_"+xaxis_variable+"_WmnG_pdfscale_WGJets_mitExt.root");
    TFile* f_pdfscale_WG = new TFile(filename);
    histo_WG_PDFUp = (TH1F*)f_pdfscale_WG->Get("h_WmnG_pdfscale_WGJets_pdfUp");
    histo_WG_PDFDown = (TH1F*)f_pdfscale_WG->Get("h_WmnG_pdfscale_WGJets_pdfDown");
    TFile* f_pdfscale_WG_ext = new TFile(filename_ext);
    TFile* f_pdfscale_WG_mitExt = new TFile(filename_mitExt);
    histo_WG_PDFUp_ext = (TH1F*)f_pdfscale_WG_ext->Get("h_WmnG_pdfscale_WGJets_ext_pdfUp");
    histo_WG_PDFDown_ext = (TH1F*)f_pdfscale_WG_ext->Get("h_WmnG_pdfscale_WGJets_ext_pdfDown");
    histo_WG_PDFUp_mitExt = (TH1F*)f_pdfscale_WG_mitExt->Get("h_WmnG_pdfscale_WGJets_mitExt_pdfUp");
    histo_WG_PDFDown_mitExt = (TH1F*)f_pdfscale_WG_mitExt->Get("h_WmnG_pdfscale_WGJets_mitExt_pdfDown");
  ...
  Float_t err_WG = 0.0;
  if(int_WG > 0.0){
    err_WG = sqrt(int_WG*int_WG*((photon_scale_factor_unc*photon_scale_factor_unc)+(muon_scale_factor_unc*muon_scale_factor_unc)+(0.65521*int_lumi*scale_factor-int_WG)/(30469887.0*int_WG))+(qcdscaleerr_WG*qcdscaleerr_WG)+(jeserr_WG*jeserr_WG)+(peserr_WG*peserr_WG)+(straighterr_WG*straighterr_WG)+(twistederr_WG*twistederr_WG)+(gammaerr_WG*gammaerr_WG)+(pdferr_WG*pdferr_WG));
  ...
  TFile *f_ZllG_130_under300 = new TFile("WmnG_JESPES_ZLLGJets_130_under300.root");
  // TFile *f_ZllG_130_over300 = new TFile("WmnG_JESPES_ZLLGJets_130_over300.root");
  TFile *f_ZllG_300 = new TFile("WmnG_JESPES_ZLLGJets_300.root");
  ...
  if(histname == "Photon_Et_range_4" || histname == "h_photonic_recoil_4" || histname == "h_phoRecoilMt_4"){
    ...
    TString filename = TString("histos_"+xaxis_variable+"_WmnG_pdfscale_ZLLGJets_130_under300.root");
    TString filename_ext = TString("histos_"+xaxis_variable+"_WmnG_pdfscale_ZLLGJets_300.root");
    TFile* f_pdfscale_ZllG_130_under300 = new TFile(filename);
    // histo_ZllG_RenUp_130_under300 = (TH1F*)f_pdfscale_ZllG_130_under300->Get("h_WmnG_pdfscale_ZLLGJets_130_under300_renUp");
    // histo_ZllG_RenDown_130_under300 = (TH1F*)f_pdfscale_ZllG_130_under300->Get("h_WmnG_pdfscale_ZLLGJets_130_under300_renDown");
    // histo_ZllG_FacUp_130_under300 = (TH1F*)f_pdfscale_ZllG_130_under300->Get("h_WmnG_pdfscale_ZLLGJets_130_under300_facUp");
    // histo_ZllG_FacDown_130_under300 = (TH1F*)f_pdfscale_ZllG_130_under300->Get("h_WmnG_pdfscale_ZLLGJets_130_under300_facDown");
    histo_ZllG_PDFUp_130_under300 = (TH1F*)f_pdfscale_ZllG_130_under300->Get("h_WmnG_pdfscale_ZLLGJets_130_under300_pdfUp");
    histo_ZllG_PDFDown_130_under300 = (TH1F*)f_pdfscale_ZllG_130_under300->Get("h_WmnG_pdfscale_ZLLGJets_130_under300_pdfDown");
    TFile* f_pdfscale_ZllG_300 = new TFile(filename_ext);
    // histo_ZllG_RenUp_300 = (TH1F*)f_pdfscale_ZllG_300->Get("h_WmnG_pdfscale_ZLLGJets_300_renUp");
    // histo_ZllG_RenDown_300 = (TH1F*)f_pdfscale_ZllG_300->Get("h_WmnG_pdfscale_ZLLGJets_300_renDown");
    // histo_ZllG_FacUp_300 = (TH1F*)f_pdfscale_ZllG_300->Get("h_WmnG_pdfscale_ZLLGJets_300_facUp");
    // histo_ZllG_FacDown_300 = (TH1F*)f_pdfscale_ZllG_300->Get("h_WmnG_pdfscale_ZLLGJets_300_facDown");
    histo_ZllG_PDFUp_300 = (TH1F*)f_pdfscale_ZllG_300->Get("h_WmnG_pdfscale_ZLLGJets_300_pdfUp");
    histo_ZllG_PDFDown_300 = (TH1F*)f_pdfscale_ZllG_300->Get("h_WmnG_pdfscale_ZLLGJets_300_pdfDown");
    // TFile* f_pdfscale_ZllG_130_over300 = new TFile("histos_WmnG_pdfscale_ZLLGJets_130_over300.root");
    // histo_ZllG_RenUp_130_over300 = (TH1F*)f_pdfscale_ZllG_130_over300->Get("h_WmnG_pdfscale_ZLLGJets_130_over300_renUp");
    // histo_ZllG_RenDown_130_over300 = (TH1F*)f_pdfscale_ZllG_130_over300->Get("h_WmnG_pdfscale_ZLLGJets_130_over300_renDown");
    // histo_ZllG_FacUp_130_over300 = (TH1F*)f_pdfscale_ZllG_130_over300->Get("h_WmnG_pdfscale_ZLLGJets_130_over300_facUp");
    // histo_ZllG_FacDown_130_over300 = (TH1F*)f_pdfscale_ZllG_130_over300->Get("h_WmnG_pdfscale_ZLLGJets_130_over300_facDown");
    // histo_ZllG_PDFUp_130_over300 = (TH1F*)f_pdfscale_ZllG_130_over300->Get("h_WmnG_pdfscale_ZLLGJets_130_over300_pdfUp");
    // histo_ZllG_PDFDown_130_over300 = (TH1F*)f_pdfscale_ZllG_130_over300->Get("h_WmnG_pdfscale_ZLLGJets_130_over300_pdfDown");
  ...
  Float_t err_TTG = 0.0;
  if(int_TTG > 0.0)
    err_TTG = sqrt(int_TTG*int_TTG*((muon_scale_factor_unc*muon_scale_factor_unc)+(photon_scale_factor_unc*photon_scale_factor_unc)+(3.697*int_lumi*scale_factor-int_TTG)/(3170400.0*int_TTG))+(jeserr_TTG*jeserr_TTG)+(peserr_TTG*peserr_TTG));
  ...
  Float_t err_TG = 0.0;
  if(int_TG > 0.0)
    err_TG = sqrt(int_TG*int_TG*((muon_scale_factor_unc*muon_scale_factor_unc)+(photon_scale_factor_unc*photon_scale_factor_unc)+(2.967*int_lumi*scale_factor-int_TG)/(310437.0*int_TG))+(jeserr_TG*jeserr_TG)+(peserr_TG*peserr_TG));
  ...
  // Float_t err_WWG = 0.0;
  // if(int_WWG > 0.0)
  //   err_WWG = sqrt(int_WWG*int_WWG*((muon_scale_factor_unc*muon_scale_factor_unc)+(photon_scale_factor_unc*photon_scale_factor_unc)+(0.2147*int_lumi*scale_factor-int_WWG)/(827604.0*int_WWG))+(jeserr_WWG*jeserr_WWG)+(peserr_WWG*peserr_WWG)+(phosferr_WWG*phosferr_WWG));
  ...
  Float_t err_WZ = 0.0;
  if(int_WZ > 0.0)
    err_WZ = sqrt(int_WZ*int_WZ*((muon_scale_factor_unc*muon_scale_factor_unc)+(photon_scale_factor_unc*photon_scale_factor_unc)+(66.1*int_lumi*scale_factor-int_WZ)/(2995783.0*int_WZ))+(jeserr_WZ*jeserr_WZ)+(peserr_WZ*peserr_WZ));
  ...
  Float_t err_WW = 0.0;
  if(int_WW > 0.0)
    err_WW = sqrt(int_WW*int_WW*((muon_scale_factor_unc*muon_scale_factor_unc)+(photon_scale_factor_unc*photon_scale_factor_unc)+(64.21*int_lumi*scale_factor-int_WW)/(6658858.0*int_WW))+(jeserr_WW*jeserr_WW)+(peserr_WW*peserr_WW));
  ...
  // TFile *f_WZG = new TFile("WmnG_JESPES_WZG.root");
  ...
  // Float_t err_WZG = 0.0;
  // if(int_WZG > 0.0)
  //   err_WZG = sqrt(int_WZG*int_WZG*((muon_scale_factor_unc*muon_scale_factor_unc)+(photon_scale_factor_unc*photon_scale_factor_unc)+(0.04123*int_lumi*scale_factor-int_WZG)/(844824.0*int_WZG))+(jeserr_WZG*jeserr_WZG)+(peserr_WZG*peserr_WZG)+(phosferr_WZG*phosferr_WZG));
  ...
  // TFile *f_WGG = new TFile("WmnG_JESPES_WGGJets.root");
  ...
  // Float_t err_WGG = 0.0;
  // if(int_WGG > 0.0)
  //   err_WGG = sqrt(int_WGG*int_WGG*((muon_scale_factor_unc*muon_scale_factor_unc)+(photon_scale_factor_unc*photon_scale_factor_unc)+(1.711*int_lumi*scale_factor-int_WGG)/(428254.0*int_WGG))+(jeserr_WGG*jeserr_WGG)+(peserr_WGG*peserr_WGG)+(phosferr_WGG*phosferr_WGG));
  ...
  // TFile *f_ZGGToLLGG = new TFile("WmnG_JESPES_ZGGToLLGG.root");
  ...
  //   err_ZGGToLLGG = sqrt(int_ZGGToLLGG*int_ZGGToLLGG*((muon_scale_factor_unc*muon_scale_factor_unc)+(photon_scale_factor_unc*photon_scale_factor_unc)+(0.6289*int_lumi*scale_factor-int_ZGGToLLGG)/(731966.0*int_ZGGToLLGG))+(jeserr_ZGGToLLGG*jeserr_ZGGToLLGG)+(peserr_ZGGToLLGG*peserr_ZGGToLLGG)+(phosferr_ZGGToLLGG*phosferr_ZGGToLLGG));
  ...
  if (histname == "Photon_Et_range_4" || histname == "h_photonic_recoil_4" || histname == "h_phoRecoilMt_4")
  {
    TFile* f_WmnG_histos;
    if(histname == "Photon_Et_range_4")
      f_WmnG_histos = new TFile("WmnG_histos_Pt.root","RECREATE");
    else if(histname == "h_photonic_recoil_4")
      f_WmnG_histos = new TFile("WmnG_histos_MET.root","RECREATE");
    else if(histname == "h_phoRecoilMt_4")
      f_WmnG_histos = new TFile("WmnG_histos_Mt.root","RECREATE");
    f_WmnG_histos->cd();
    histo_data->Write();
    histo_jetfake->Write();
  ...
  for(int i = 1; i <= nBins; i++){
    ...
    binerror = sqrt(sum_binerrors_squared+pow(background*photon_scale_factor_unc,2)+pow(background*muon_scale_factor_unc,2)+pow(jeserr,2)+pow(peserr,2)+pow(straighterr_WG,2)+pow(twistederr_WG,2)+pow(gammaerr_WG,2)+pow(straighterr_ZllG,2)+pow(twistederr_ZllG,2)+pow(gammaerr_ZllG,2)+pow(renerr,2)+pow(facerr,2)+pow(pdferr,2)+pow(qcdscaleerr_WG,2)+pow(qcdscaleerr_ZllG,2)+pow(jetfakeerr,2));
