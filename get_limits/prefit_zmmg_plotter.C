...
void plot(Double_t leg_xoffset, Double_t leg_yoffset, TString xaxis_title, TString plotname)
{
  ...
  TGraphAsymmErrors* tgae_data = (TGraphAsymmErrors*)((TGraphAsymmErrors*)f_postfit_shapes->Get("shapes_prefit/CR_DM/data"))->Clone("tgae_data");
  ...
  TH1F* histo_jetfake = (TH1F*)((TH1F*)f_postfit_shapes->Get("shapes_prefit/CR_DM/QCD"))->Clone("histo_jetfake");
  ...
  TH1F* histo_ZllG_combined = (TH1F*)((TH1F*)f_postfit_shapes->Get("shapes_prefit/CR_DM/ZllG"))->Clone("histo_ZllG_combined");
  for(int i = 1; i <= nBins; i++){
  ...
  TH1F* histo_TTG = (TH1F*)((TH1F*)f_postfit_shapes->Get("shapes_prefit/CR_DM/TTG"))->Clone("histo_TTG");
  for(int i = 1; i <= nBins; i++){
  ...
  TH1F* histo_WZ = (TH1F*)((TH1F*)f_postfit_shapes->Get("shapes_prefit/CR_DM/WZ"))->Clone("histo_WZ");
  for(int i = 1; i <= nBins; i++){
