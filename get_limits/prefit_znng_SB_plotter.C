...
void plot(Double_t leg_xoffset, Double_t leg_yoffset, TString xaxis_title, TString plotname)
{
  ...
  TGraphAsymmErrors* tgae_data = (TGraphAsymmErrors*)((TGraphAsymmErrors*)f_postfit_shapes->Get("shapes_prefit/SB/data"))->Clone("tgae_data");
  ...
  TH1F* histo_jetfake = (TH1F*)((TH1F*)f_postfit_shapes->Get("shapes_prefit/SB/QCD"))->Clone("histo_jetfake");
  ...
  TH1F* histo_spikes = (TH1F*)((TH1F*)f_postfit_shapes->Get("shapes_prefit/SB/Spikes"))->Clone("histo_spikes");
  ...
  TH1F* histo_elefake = (TH1F*)((TH1F*)f_postfit_shapes->Get("shapes_prefit/SB/Elefake"))->Clone("histo_elefake");
  ...
  TH1F* histo_bhalo = (TH1F*)((TH1F*)f_postfit_shapes->Get("shapes_prefit/SB/BHalo"))->Clone("histo_bhalo");
  ...
  TH1F* histo_ZNuNuG = (TH1F*)((TH1F*)f_postfit_shapes->Get("shapes_prefit/SB/ZnunuG"))->Clone("histo_ZNuNuG");
  ...
  TH1F* histo_WG = (TH1F*)((TH1F*)f_postfit_shapes->Get("shapes_prefit/SB/WG"))->Clone("histo_WG");
  ...
  TH1F* histo_GJets_40toInf = (TH1F*)((TH1F*)f_postfit_shapes->Get("shapes_prefit/SB/GJets"))->Clone("histo_GJets_40toInf");
  ...
  TH1F* histo_ZllG_combined = (TH1F*)((TH1F*)f_postfit_shapes->Get("shapes_prefit/SB/ZllG_MC"))->Clone("histo_ZllG_combined");
  ...
  TH1F* histo_TTG = (TH1F*)((TH1F*)f_postfit_shapes->Get("shapes_prefit/SB/TTG"))->Clone("histo_TTG");
  ...
  TH1F* histo_TG = (TH1F*)((TH1F*)f_postfit_shapes->Get("shapes_prefit/SB/TG"))->Clone("histo_TG");
  ...
  TH1F* histo_diphoton = (TH1F*)((TH1F*)f_postfit_shapes->Get("shapes_prefit/SB/Diphoton"))->Clone("histo_diphoton");
  ...
  TH1F* histo_WZ = (TH1F*)((TH1F*)f_postfit_shapes->Get("shapes_prefit/SB/WZ"))->Clone("histo_WZ");
  ...
  TH1F* histo_ZZ = (TH1F*)((TH1F*)f_postfit_shapes->Get("shapes_prefit/SB/ZZ"))->Clone("histo_ZZ");
  ...
  TH1F* histo_WMuNu = (TH1F*)((TH1F*)f_postfit_shapes->Get("shapes_prefit/SB/WMuNu"))->Clone("histo_WMuNu");
  ...
  TH1F* histo_WTauNu = (TH1F*)((TH1F*)f_postfit_shapes->Get("shapes_prefit/SB/WTauNu"))->Clone("histo_WTauNu");
  ...
  TH1F* histo_WW = (TH1F*)((TH1F*)f_postfit_shapes->Get("shapes_prefit/SB/WW"))->Clone("histo_WW");
