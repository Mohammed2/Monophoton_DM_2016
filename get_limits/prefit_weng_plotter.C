...
void plot(Double_t leg_xoffset, Double_t leg_yoffset, TString xaxis_title, TString plotname)
{
  ...
  TGraphAsymmErrors* tgae_data = (TGraphAsymmErrors*)((TGraphAsymmErrors*)f_postfit_shapes->Get("shapes_prefit/CR_ME/data"))->Clone("tgae_data");
  ...
  TH1F* histo_elefake = (TH1F*)((TH1F*)f_postfit_shapes->Get("shapes_prefit/CR_ME/Elefake"))->Clone("histo_elefake");
  for(int i = 1; i <= nBins; i++){
  ...
  TH1F* histo_WG = (TH1F*)((TH1F*)f_postfit_shapes->Get("shapes_prefit/CR_ME/WG"))->Clone("histo_WG");
  ...
  TH1F* histo_jetfake = (TH1F*)((TH1F*)f_postfit_shapes->Get("shapes_prefit/CR_ME/QCD"))->Clone("histo_jetfake");
  for(int i = 1; i <= nBins; i++){
  ...
  TH1F* histo_ZllG_combined = (TH1F*)((TH1F*)f_postfit_shapes->Get("shapes_prefit/CR_ME/ZllG_MC"))->Clone("histo_ZllG_combined");
  for(int i = 1; i <= nBins; i++){
  ...
  TH1F* histo_TTG = (TH1F*)((TH1F*)f_postfit_shapes->Get("shapes_prefit/CR_ME/TTG"))->Clone("histo_TTG");
  for(int i = 1; i <= nBins; i++){
  ...
  TH1F* histo_TG = (TH1F*)((TH1F*)f_postfit_shapes->Get("shapes_prefit/CR_ME/TG"))->Clone("histo_TG");
  for(int i = 1; i <= nBins; i++){
  ...
  TH1F* histo_diphoton = (TH1F*)((TH1F*)f_postfit_shapes->Get("shapes_prefit/CR_ME/Diphoton"))->Clone("histo_diphoton");
  for(int i = 1; i <= nBins; i++){
  ...
  TH1F* histo_WZ = (TH1F*)((TH1F*)f_postfit_shapes->Get("shapes_prefit/CR_ME/WZ"))->Clone("histo_WZ");
  for(int i = 1; i <= nBins; i++){
  ...
  TH1F* histo_WW = (TH1F*)((TH1F*)f_postfit_shapes->Get("shapes_prefit/CR_ME/WW"))->Clone("histo_WW");
  for(int i = 1; i <= nBins; i++){
  ...
  leg->AddEntry(histo_WZ,"Diboson","F");
